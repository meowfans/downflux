...
import { type BoKepPornExecArgs, type BoKepPornOutput } from './BoKepPornContracts';
...
export class BoKepPornPipeline extends BasePipeline<BoKepPornExecArgs, BoKepPornOutput> {
	...
	protected override mappings(metadata: BoKepPornOutput, request: BoKepPornExecArgs): PipelineMappings {
		return [
			this.createMappings(
