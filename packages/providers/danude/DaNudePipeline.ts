...
import { type DaNudeExecArgs, type DaNudeOutput } from './DaNudeContracts';
 ...
 */
export class DaNudePipeline extends BasePipeline<DaNudeExecArgs, DaNudeOutput> {
	protected override buildIdentifier(ctx: IdentifierContext<DaNudeOutput>): string {
	...
	protected override mappings(metadata: DaNudeOutput, request: DaNudeExecArgs): PipelineMappings {
		return [
			this.createMappings(
