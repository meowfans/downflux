...
import { type ZbPornExecArgs, type ZbPornOutput } from './ZbPornContracts';
...
export class ZbPornPipeline extends BasePipeline<ZbPornExecArgs, ZbPornOutput> {
	...
	protected override mappings(metadata: ZbPornOutput, request: ZbPornExecArgs): PipelineMappings {
		return [
			this.createMappings(
