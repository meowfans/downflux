...
[downflux](../README.md) / WikiArtTransformer

# Class: WikiArtTransformer

Defined in: [packages/providers/wikiart/WikiArtTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikiart/WikiArtTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`WikiArtExecArgs`](../interfaces/WikiArtExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new WikiArtTransformer**(`httpClient`, `progressManager`): `WikiArtTransformer`
...
Defined in: [packages/providers/wikiart/WikiArtTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikiart/WikiArtTransformer.ts#L9)
