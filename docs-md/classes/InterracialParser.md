...
[downflux](../README.md) / InterracialParser

# Class: InterracialParser

Defined in: [packages/providers/interracial/InterracialParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/interracial/InterracialParser.ts#L13)
...
> **new InterracialParser**(): `InterracialParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`InterracialOutput`](../interfaces/InterracialOutput.md)\>\>\>

Defined in: [packages/providers/interracial/InterracialParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/interracial/InterracialParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`InterracialOutput`](../interfaces/InterracialOutput.md)\>\>\>
