...
[downflux](../README.md) / BlueskyProvider

# Class: BlueskyProvider

Defined in: [packages/providers/bluesky/BlueskyProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bluesky/BlueskyProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`BlueskyExecArgs`](../interfaces/BlueskyExecArgs.md)\>

## Constructors

### Constructor

> **new BlueskyProvider**(`url`): `BlueskyProvider`

Defined in: [packages/providers/bluesky/BlueskyProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bluesky/BlueskyProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`BlueskyExecArgs`](../interfaces/BlueskyExecArgs.md)
...
`Partial`\<[`BlueskyExecArgs`](../interfaces/BlueskyExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`BlueskyExecArgs`](../interfaces/BlueskyExecArgs.md) & `object`
