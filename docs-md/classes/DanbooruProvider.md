...
[downflux](../README.md) / DanbooruProvider

# Class: DanbooruProvider

Defined in: [packages/providers/danbooru/DanbooruProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danbooru/DanbooruProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`DanbooruExecArgs`](../interfaces/DanbooruExecArgs.md)\>

## Constructors

### Constructor

> **new DanbooruProvider**(`url`): `DanbooruProvider`

Defined in: [packages/providers/danbooru/DanbooruProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danbooru/DanbooruProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`DanbooruExecArgs`](../interfaces/DanbooruExecArgs.md)
...
`Partial`\<[`DanbooruExecArgs`](../interfaces/DanbooruExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`DanbooruExecArgs`](../interfaces/DanbooruExecArgs.md) & `object`
