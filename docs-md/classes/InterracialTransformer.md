...
[downflux](../README.md) / InterracialTransformer

# Class: InterracialTransformer

Defined in: [packages/providers/interracial/InterracialTransformer.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/interracial/InterracialTransformer.ts#L14)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`InterracialExecArgs`](../interfaces/InterracialExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`InterracialVideoOutput`](../interfaces/InterracialVideoOutput.md)\>

## Constructors

### Constructor

> **new InterracialTransformer**(`httpClient`, `progressManager`): `InterracialTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`InterracialVideoOutput`](../interfaces/InterracialVideoOutput.md)\>

Defined in: [packages/providers/interracial/InterracialTransformer.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/interracial/InterracialTransformer.ts#L15)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`InterracialVideoOutput`](../interfaces/InterracialVideoOutput.md)\>
