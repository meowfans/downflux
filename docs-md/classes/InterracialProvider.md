...
[downflux](../README.md) / InterracialProvider

# Class: InterracialProvider

Defined in: [packages/providers/interracial/InterracialProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/interracial/InterracialProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`InterracialExecArgs`](../interfaces/InterracialExecArgs.md)\>

## Constructors

### Constructor

> **new InterracialProvider**(`url`): `InterracialProvider`

Defined in: [packages/providers/interracial/InterracialProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/interracial/InterracialProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`Interracial`](../enumerations/Provider.md#interracial) = `Provider.Interracial`

Defined in: [packages/providers/interracial/InterracialProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/interracial/InterracialProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`InterracialExecArgs`](../interfaces/InterracialExecArgs.md)
...
`Partial`\<[`InterracialExecArgs`](../interfaces/InterracialExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`InterracialExecArgs`](../interfaces/InterracialExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`InterracialVideoOutput`](../interfaces/InterracialVideoOutput.md)\>

Defined in: [packages/providers/interracial/InterracialProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/interracial/InterracialProvider.ts#L45)

#### Returns

`Promise`\<[`InterracialVideoOutput`](../interfaces/InterracialVideoOutput.md)\>
