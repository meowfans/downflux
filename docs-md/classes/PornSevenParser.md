...
[downflux](../README.md) / PornSevenParser

# Class: PornSevenParser

Defined in: [packages/providers/pornseven/PornSevenParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornseven/PornSevenParser.ts#L13)
...
> **new PornSevenParser**(): `PornSevenParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PornSevenOutput`](../interfaces/PornSevenOutput.md)\>\>\>

Defined in: [packages/providers/pornseven/PornSevenParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornseven/PornSevenParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PornSevenOutput`](../interfaces/PornSevenOutput.md)\>\>\>
