...
[downflux](../README.md) / PinterestTransformer

# Class: PinterestTransformer

Defined in: [packages/providers/pinterest/PinterestTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pinterest/PinterestTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`PinterestExecArgs`](../interfaces/PinterestExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new PinterestTransformer**(`httpClient`, `progressManager`): `PinterestTransformer`
...
Defined in: [packages/providers/pinterest/PinterestTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pinterest/PinterestTransformer.ts#L9)
