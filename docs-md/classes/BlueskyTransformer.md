...
[downflux](../README.md) / BlueskyTransformer

# Class: BlueskyTransformer

Defined in: [packages/providers/bluesky/BlueskyTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bluesky/BlueskyTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`BlueskyExecArgs`](../interfaces/BlueskyExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new BlueskyTransformer**(`httpClient`, `progressManager`): `BlueskyTransformer`
...
Defined in: [packages/providers/bluesky/BlueskyTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bluesky/BlueskyTransformer.ts#L9)
