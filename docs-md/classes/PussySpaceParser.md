...
[downflux](../README.md) / PussySpaceParser

# Class: PussySpaceParser

Defined in: [packages/providers/pussyspace/PussySpaceParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pussyspace/PussySpaceParser.ts#L13)
...
> **new PussySpaceParser**(): `PussySpaceParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PussySpaceOutput`](../interfaces/PussySpaceOutput.md)\>\>\>

Defined in: [packages/providers/pussyspace/PussySpaceParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pussyspace/PussySpaceParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PussySpaceOutput`](../interfaces/PussySpaceOutput.md)\>\>\>
