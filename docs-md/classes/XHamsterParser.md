...
[downflux](../README.md) / XHamsterParser

# Class: XHamsterParser

Defined in: [packages/providers/xhamster/XHamsterParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xhamster/XHamsterParser.ts#L13)
...
> **new XHamsterParser**(): `XHamsterParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`XHamsterOutput`](../interfaces/XHamsterOutput.md)\>\>\>

Defined in: [packages/providers/xhamster/XHamsterParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xhamster/XHamsterParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`XHamsterOutput`](../interfaces/XHamsterOutput.md)\>\>\>
