...
[downflux](../README.md) / BehanceProvider

# Class: BehanceProvider

Defined in: [packages/providers/behance/BehanceProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/behance/BehanceProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`BehanceExecArgs`](../interfaces/BehanceExecArgs.md)\>

## Constructors

### Constructor

> **new BehanceProvider**(`url`): `BehanceProvider`

Defined in: [packages/providers/behance/BehanceProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/behance/BehanceProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`BehanceExecArgs`](../interfaces/BehanceExecArgs.md)
...
`Partial`\<[`BehanceExecArgs`](../interfaces/BehanceExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`BehanceExecArgs`](../interfaces/BehanceExecArgs.md) & `object`
