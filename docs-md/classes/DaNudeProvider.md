...
[downflux](../README.md) / DaNudeProvider

# Class: DaNudeProvider

Defined in: [packages/providers/danude/DaNudeProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danude/DaNudeProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`DaNudeExecArgs`](../interfaces/DaNudeExecArgs.md)\>

## Constructors

### Constructor

> **new DaNudeProvider**(`url`): `DaNudeProvider`

Defined in: [packages/providers/danude/DaNudeProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danude/DaNudeProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`DaNude`](../enumerations/Provider.md#danude) = `Provider.DaNude`

Defined in: [packages/providers/danude/DaNudeProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danude/DaNudeProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`DaNudeExecArgs`](../interfaces/DaNudeExecArgs.md)
...
`Partial`\<[`DaNudeExecArgs`](../interfaces/DaNudeExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`DaNudeExecArgs`](../interfaces/DaNudeExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`DaNudeVideoOutput`](../interfaces/DaNudeVideoOutput.md)\>

Defined in: [packages/providers/danude/DaNudeProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danude/DaNudeProvider.ts#L45)

#### Returns

`Promise`\<[`DaNudeVideoOutput`](../interfaces/DaNudeVideoOutput.md)\>
