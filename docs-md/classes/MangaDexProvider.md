...
[downflux](../README.md) / MangaDexProvider

# Class: MangaDexProvider

Defined in: [packages/providers/mangadex/MangaDexProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mangadex/MangaDexProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`MangaDexExecArgs`](../interfaces/MangaDexExecArgs.md)\>

## Constructors

### Constructor

> **new MangaDexProvider**(`url`): `MangaDexProvider`

Defined in: [packages/providers/mangadex/MangaDexProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mangadex/MangaDexProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`MangaDexExecArgs`](../interfaces/MangaDexExecArgs.md)
...
`Partial`\<[`MangaDexExecArgs`](../interfaces/MangaDexExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`MangaDexExecArgs`](../interfaces/MangaDexExecArgs.md) & `object`
