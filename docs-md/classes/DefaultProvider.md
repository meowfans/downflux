...
[downflux](../README.md) / DefaultProvider

# Class: DefaultProvider

Defined in: [packages/providers/default/DefaultProvider.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/default/DefaultProvider.ts#L9)
...
- [`BaseProvider`](BaseProvider.md)\<[`DefaultExecArgs`](../interfaces/DefaultExecArgs.md)\>

## Constructors

### Constructor

> **new DefaultProvider**(`url`): `DefaultProvider`

Defined in: [packages/providers/default/DefaultProvider.ts:12](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/default/DefaultProvider.ts#L12)
...
[`BaseProvider`](BaseProvider.md).[`httpOptions`](BaseProvider.md#httpoptions)
...
[`BaseProvider`](BaseProvider.md).[`deps`](BaseProvider.md#deps)
...
[`BaseProvider`](BaseProvider.md).[`urlPattern`](BaseProvider.md#urlpattern)
...
[`BaseProvider`](BaseProvider.md).[`providerMetadata`](BaseProvider.md#providermetadata)
...
[`BaseProvider`](BaseProvider.md).[`config`](BaseProvider.md#config)

***

### provider

> `protected` `readonly` **provider**: [`Default`](../enumerations/Provider.md#default) = `Provider.Default`

Defined in: [packages/providers/default/DefaultProvider.ts:10](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/default/DefaultProvider.ts#L10)
...
[`BaseProvider`](BaseProvider.md).[`metadata`](BaseProvider.md#metadata)
...
[`BaseProvider`](BaseProvider.md).[`HOST_NAME`](BaseProvider.md#host_name)
...
> `protected` **buildRequest**(`overrides?`): [`DefaultExecArgs`](../interfaces/DefaultExecArgs.md)
...
`Partial`\<[`DefaultExecArgs`](../interfaces/DefaultExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`DefaultExecArgs`](../interfaces/DefaultExecArgs.md) & `object`
...
Defined in: [packages/providers/default/DefaultProvider.ts:35](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/default/DefaultProvider.ts#L35)
...
Defined in: [packages/providers/default/DefaultProvider.ts:49](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/default/DefaultProvider.ts#L49)
...
Defined in: [packages/providers/default/DefaultProvider.ts:63](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/default/DefaultProvider.ts#L63)
...
Defined in: [packages/providers/default/DefaultProvider.ts:77](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/default/DefaultProvider.ts#L77)
