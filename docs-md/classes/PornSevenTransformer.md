...
[downflux](../README.md) / PornSevenTransformer

# Class: PornSevenTransformer

Defined in: [packages/providers/pornseven/PornSevenTransformer.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornseven/PornSevenTransformer.ts#L14)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`PornSevenExecArgs`](../interfaces/PornSevenExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`PornSevenVideoOutput`](../interfaces/PornSevenVideoOutput.md)\>

## Constructors

### Constructor

> **new PornSevenTransformer**(`httpClient`, `progressManager`): `PornSevenTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`PornSevenVideoOutput`](../interfaces/PornSevenVideoOutput.md)\>

Defined in: [packages/providers/pornseven/PornSevenTransformer.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornseven/PornSevenTransformer.ts#L15)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`PornSevenVideoOutput`](../interfaces/PornSevenVideoOutput.md)\>
