...
[downflux](../README.md) / WikimediaProvider

# Class: WikimediaProvider

Defined in: [packages/providers/wikimedia/WikimediaProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikimedia/WikimediaProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`WikimediaExecArgs`](../interfaces/WikimediaExecArgs.md)\>
...
Defined in: [packages/providers/wikimedia/WikimediaProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikimedia/WikimediaProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`WikimediaExecArgs`](../interfaces/WikimediaExecArgs.md)
...
`Partial`\<[`WikimediaExecArgs`](../interfaces/WikimediaExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`WikimediaExecArgs`](../interfaces/WikimediaExecArgs.md) & `object`
