...
[downflux](../README.md) / MyLustParser

# Class: MyLustParser

Defined in: [packages/providers/mylust/MyLustParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustParser.ts#L13)
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`MyLustOutput`](../interfaces/MyLustOutput.md)\>\>\>

Defined in: [packages/providers/mylust/MyLustParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`MyLustOutput`](../interfaces/MyLustOutput.md)\>\>\>
