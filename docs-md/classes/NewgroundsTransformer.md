...
[downflux](../README.md) / NewgroundsTransformer

# Class: NewgroundsTransformer

Defined in: [packages/providers/newgrounds/NewgroundsTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/newgrounds/NewgroundsTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`NewgroundsExecArgs`](../interfaces/NewgroundsExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new NewgroundsTransformer**(`httpClient`, `progressManager`): `NewgroundsTransformer`
...
Defined in: [packages/providers/newgrounds/NewgroundsTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/newgrounds/NewgroundsTransformer.ts#L9)
