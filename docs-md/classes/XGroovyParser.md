...
[downflux](../README.md) / XGroovyParser

# Class: XGroovyParser

Defined in: [packages/providers/xgroovy/XGroovyParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xgroovy/XGroovyParser.ts#L13)
...
> **new XGroovyParser**(): `XGroovyParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`XGroovyOutput`](../interfaces/XGroovyOutput.md)\>\>\>

Defined in: [packages/providers/xgroovy/XGroovyParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xgroovy/XGroovyParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`XGroovyOutput`](../interfaces/XGroovyOutput.md)\>\>\>
