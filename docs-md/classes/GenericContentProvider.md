...
[downflux](../README.md) / GenericContentProvider

# Abstract Class: GenericContentProvider\<TExec\>

Defined in: [packages/providers/shared/GenericContentProvider.ts:24](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/shared/GenericContentProvider.ts#L24)
...
- [`BaseProvider`](BaseProvider.md)\<`TExec`\>

## Extended by

- [`ArtStationProvider`](ArtStationProvider.md)
- [`BehanceProvider`](BehanceProvider.md)
- [`BlueskyProvider`](BlueskyProvider.md)
- [`DanbooruProvider`](DanbooruProvider.md)
- [`DeviantArtProvider`](DeviantArtProvider.md)
- [`FlickrProvider`](FlickrProvider.md)
- [`GelbooruProvider`](GelbooruProvider.md)
- [`ImgurProvider`](ImgurProvider.md)
- [`InstagramProvider`](InstagramProvider.md)
- [`MangaDexProvider`](MangaDexProvider.md)
- [`MastodonProvider`](MastodonProvider.md)
- [`NewgroundsProvider`](NewgroundsProvider.md)
- [`PexelsProvider`](PexelsProvider.md)
- [`PinterestProvider`](PinterestProvider.md)
- [`PixivProvider`](PixivProvider.md)
- [`RedditProvider`](RedditProvider.md)
- [`TikTokProvider`](TikTokProvider.md)
- [`TumblrProvider`](TumblrProvider.md)
- [`UnsplashProvider`](UnsplashProvider.md)
- [`WikiArtProvider`](WikiArtProvider.md)
- [`WikimediaProvider`](WikimediaProvider.md)

## Type Parameters

### TExec

`TExec` *extends* [`ExecutionArgs`](../interfaces/ExecutionArgs.md) = [`ExecutionArgs`](../interfaces/ExecutionArgs.md)

## Constructors

### Constructor

> **new GenericContentProvider**\<`TExec`\>(`url`, `config`): `GenericContentProvider`\<`TExec`\>

Defined in: [packages/providers/shared/GenericContentProvider.ts:25](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/shared/GenericContentProvider.ts#L25)
