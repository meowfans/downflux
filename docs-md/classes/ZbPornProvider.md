...
[downflux](../README.md) / ZbPornProvider

# Class: ZbPornProvider

Defined in: [packages/providers/zbporn/ZbPornProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/zbporn/ZbPornProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`ZbPornExecArgs`](../interfaces/ZbPornExecArgs.md)\>

## Constructors

### Constructor

> **new ZbPornProvider**(`url`): `ZbPornProvider`

Defined in: [packages/providers/zbporn/ZbPornProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/zbporn/ZbPornProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`ZbPorn`](../enumerations/Provider.md#zbporn) = `Provider.ZbPorn`

Defined in: [packages/providers/zbporn/ZbPornProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/zbporn/ZbPornProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`ZbPornExecArgs`](../interfaces/ZbPornExecArgs.md)
...
`Partial`\<[`ZbPornExecArgs`](../interfaces/ZbPornExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`ZbPornExecArgs`](../interfaces/ZbPornExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`ZbPornVideoOutput`](../interfaces/ZbPornVideoOutput.md)\>

Defined in: [packages/providers/zbporn/ZbPornProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/zbporn/ZbPornProvider.ts#L45)

#### Returns

`Promise`\<[`ZbPornVideoOutput`](../interfaces/ZbPornVideoOutput.md)\>
