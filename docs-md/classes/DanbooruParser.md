...
[downflux](../README.md) / DanbooruParser

# Class: DanbooruParser

Defined in: [packages/providers/danbooru/DanbooruParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danbooru/DanbooruParser.ts#L7)
...
> **new DanbooruParser**(): `DanbooruParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`DanbooruOutput`](../interfaces/DanbooruOutput.md)\>\>\>

Defined in: [packages/providers/danbooru/DanbooruParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danbooru/DanbooruParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`DanbooruOutput`](../interfaces/DanbooruOutput.md)\>\>\>
