...
[downflux](../README.md) / PornSevenProvider

# Class: PornSevenProvider

Defined in: [packages/providers/pornseven/PornSevenProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornseven/PornSevenProvider.ts#L16)
...
- [`BaseProvider`](BaseProvider.md)\<[`PornSevenExecArgs`](../interfaces/PornSevenExecArgs.md)\>

## Constructors

### Constructor

> **new PornSevenProvider**(`url`): `PornSevenProvider`

Defined in: [packages/providers/pornseven/PornSevenProvider.ts:20](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornseven/PornSevenProvider.ts#L20)
...
> `protected` `readonly` **provider**: [`PornSeven`](../enumerations/Provider.md#pornseven) = `Provider.PornSeven`

Defined in: [packages/providers/pornseven/PornSevenProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornseven/PornSevenProvider.ts#L17)
...
> `protected` **buildRequest**(`overrides?`): [`PornSevenExecArgs`](../interfaces/PornSevenExecArgs.md)
...
`Partial`\<[`PornSevenExecArgs`](../interfaces/PornSevenExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`PornSevenExecArgs`](../interfaces/PornSevenExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`PornSevenVideoOutput`](../interfaces/PornSevenVideoOutput.md)\>

Defined in: [packages/providers/pornseven/PornSevenProvider.ts:46](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornseven/PornSevenProvider.ts#L46)

#### Returns

`Promise`\<[`PornSevenVideoOutput`](../interfaces/PornSevenVideoOutput.md)\>
