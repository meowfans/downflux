...
[downflux](../README.md) / XDeguTransformer

# Class: XDeguTransformer

Defined in: [packages/providers/xdegu/XDeguTransformer.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xdegu/XDeguTransformer.ts#L14)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`XDeguExecArgs`](../interfaces/XDeguExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`XDeguVideoOutput`](../interfaces/XDeguVideoOutput.md)\>

## Constructors

### Constructor

> **new XDeguTransformer**(`httpClient`, `progressManager`): `XDeguTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`XDeguVideoOutput`](../interfaces/XDeguVideoOutput.md)\>

Defined in: [packages/providers/xdegu/XDeguTransformer.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xdegu/XDeguTransformer.ts#L15)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`XDeguVideoOutput`](../interfaces/XDeguVideoOutput.md)\>
