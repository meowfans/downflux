...
[downflux](../README.md) / FlickrProvider

# Class: FlickrProvider

Defined in: [packages/providers/flickr/FlickrProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/flickr/FlickrProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`FlickrExecArgs`](../interfaces/FlickrExecArgs.md)\>

## Constructors

### Constructor

> **new FlickrProvider**(`url`): `FlickrProvider`

Defined in: [packages/providers/flickr/FlickrProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/flickr/FlickrProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`FlickrExecArgs`](../interfaces/FlickrExecArgs.md)
...
`Partial`\<[`FlickrExecArgs`](../interfaces/FlickrExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`FlickrExecArgs`](../interfaces/FlickrExecArgs.md) & `object`
