...
[downflux](../README.md) / NewgroundsProvider

# Class: NewgroundsProvider

Defined in: [packages/providers/newgrounds/NewgroundsProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/newgrounds/NewgroundsProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`NewgroundsExecArgs`](../interfaces/NewgroundsExecArgs.md)\>

## Constructors

### Constructor

> **new NewgroundsProvider**(`url`): `NewgroundsProvider`

Defined in: [packages/providers/newgrounds/NewgroundsProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/newgrounds/NewgroundsProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`NewgroundsExecArgs`](../interfaces/NewgroundsExecArgs.md)
...
`Partial`\<[`NewgroundsExecArgs`](../interfaces/NewgroundsExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`NewgroundsExecArgs`](../interfaces/NewgroundsExecArgs.md) & `object`
