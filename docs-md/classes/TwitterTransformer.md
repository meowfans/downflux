...
[downflux](../README.md) / TwitterTransformer

# Class: TwitterTransformer

Defined in: [packages/providers/twitter/TwitterTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`TwitterExecArgs`](../interfaces/TwitterExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`TwitterPostOutput`](../interfaces/TwitterPostOutput.md) \| [`TwitterTimelineOutput`](../interfaces/TwitterTimelineOutput.md)\>

## Constructors

### Constructor

> **new TwitterTransformer**(`httpClient`, `progressManager`): `TwitterTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`TwitterPostOutput`](../interfaces/TwitterPostOutput.md) \| [`TwitterTimelineOutput`](../interfaces/TwitterTimelineOutput.md)\>

Defined in: [packages/providers/twitter/TwitterTransformer.ts:12](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterTransformer.ts#L12)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`TwitterPostOutput`](../interfaces/TwitterPostOutput.md) \| [`TwitterTimelineOutput`](../interfaces/TwitterTimelineOutput.md)\>
