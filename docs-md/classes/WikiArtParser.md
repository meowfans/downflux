...
[downflux](../README.md) / WikiArtParser

# Class: WikiArtParser

Defined in: [packages/providers/wikiart/WikiArtParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikiart/WikiArtParser.ts#L7)
...
> **new WikiArtParser**(): `WikiArtParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`WikiArtOutput`](../interfaces/WikiArtOutput.md)\>\>\>

Defined in: [packages/providers/wikiart/WikiArtParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikiart/WikiArtParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`WikiArtOutput`](../interfaces/WikiArtOutput.md)\>\>\>
