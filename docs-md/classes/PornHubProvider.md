...
[downflux](../README.md) / PornHubProvider

# Class: PornHubProvider

Defined in: [packages/providers/pornhub/PornHubProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornhub/PornHubProvider.ts#L16)
...
- [`BaseProvider`](BaseProvider.md)\<[`PornHubExecArgs`](../interfaces/PornHubExecArgs.md)\>

## Constructors

### Constructor

> **new PornHubProvider**(`url`): `PornHubProvider`

Defined in: [packages/providers/pornhub/PornHubProvider.ts:30](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornhub/PornHubProvider.ts#L30)
...
> `protected` `readonly` **provider**: [`PornHub`](../enumerations/Provider.md#pornhub) = `Provider.PornHub`

Defined in: [packages/providers/pornhub/PornHubProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornhub/PornHubProvider.ts#L17)
...
> `protected` **buildRequest**(`overrides?`): [`PornHubExecArgs`](../interfaces/PornHubExecArgs.md)
...
`Partial`\<[`PornHubExecArgs`](../interfaces/PornHubExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`PornHubExecArgs`](../interfaces/PornHubExecArgs.md) & `object`
...
> **getVideo**(`quality?`): `Promise`\<[`PornHubVideoOutput`](../interfaces/PornHubVideoOutput.md)\>

Defined in: [packages/providers/pornhub/PornHubProvider.ts:100](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornhub/PornHubProvider.ts#L100)
...
allowed video quality (e.g., 720p, 1080p). If not specified, highest quality will be returned.

#### Returns

`Promise`\<[`PornHubVideoOutput`](../interfaces/PornHubVideoOutput.md)\>

`PornHubVideoOutput` containing video metadata and source URLs

#### Default Value

`viewKey` is collected from the entry URL query param if exists

#### Throws

`GenericException` When the view key is missing or invalid
true
...
> **getVideos**(`args?`, `range?`): `Promise`\<[`PornHubVideosOutput`](../interfaces/PornHubVideosOutput.md)[]\>

Defined in: [packages/providers/pornhub/PornHubProvider.ts:124](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornhub/PornHubProvider.ts#L124)
...
options parameter to specify username, type of videos and quality
...
`Promise`\<[`PornHubVideosOutput`](../interfaces/PornHubVideosOutput.md)[]\>

`PornHubVideosOutput[]` containing video urls
This method does not download videos only returns array or urls

#### Throws

`GenericException` when the username or type is missing, usually derived from URL if exists

***

### getVideosFromAnyUrl()

> **getVideosFromAnyUrl**(`format?`): `Promise`\<[`PornHubVideosOutput`](../interfaces/PornHubVideosOutput.md)[]\>

Defined in: [packages/providers/pornhub/PornHubProvider.ts:168](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornhub/PornHubProvider.ts#L168)
...
options parameter to specify format of the videos
...
`GenericException` when the URL format is invalid or unsupported

***

### getChannels()

> **getChannels**(`type?`, `range?`): `Promise`\<[`PornHubChannelsOutput`](../interfaces/PornHubChannelsOutput.md)[]\>

Defined in: [packages/providers/pornhub/PornHubProvider.ts:179](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornhub/PornHubProvider.ts#L179)

#### Parameters

##### type?

[`PornHubChannelsQueryArgsType`](../type-aliases/PornHubChannelsQueryArgsType.md) = `'most_popular'`
...
`Promise`\<[`PornHubChannelsOutput`](../interfaces/PornHubChannelsOutput.md)[]\>
