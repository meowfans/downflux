...
[downflux](../README.md) / UnsplashTransformer

# Class: UnsplashTransformer

Defined in: [packages/providers/unsplash/UnsplashTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/unsplash/UnsplashTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`UnsplashExecArgs`](../interfaces/UnsplashExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new UnsplashTransformer**(`httpClient`, `progressManager`): `UnsplashTransformer`
...
Defined in: [packages/providers/unsplash/UnsplashTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/unsplash/UnsplashTransformer.ts#L9)
