...
[downflux](../README.md) / SexVidProvider

# Class: SexVidProvider

Defined in: [packages/providers/sexvid/SexVidProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sexvid/SexVidProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`SexVidExecArgs`](../interfaces/SexVidExecArgs.md)\>

## Constructors

### Constructor

> **new SexVidProvider**(`url`): `SexVidProvider`

Defined in: [packages/providers/sexvid/SexVidProvider.ts:18](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sexvid/SexVidProvider.ts#L18)
...
> `protected` `readonly` **provider**: [`SexVid`](../enumerations/Provider.md#sexvid) = `Provider.SexVid`

Defined in: [packages/providers/sexvid/SexVidProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sexvid/SexVidProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`SexVidExecArgs`](../interfaces/SexVidExecArgs.md)
...
`Partial`\<[`SexVidExecArgs`](../interfaces/SexVidExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`SexVidExecArgs`](../interfaces/SexVidExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`SexVidVideoOutput`](../interfaces/SexVidVideoOutput.md)\>

Defined in: [packages/providers/sexvid/SexVidProvider.ts:46](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sexvid/SexVidProvider.ts#L46)

#### Returns

`Promise`\<[`SexVidVideoOutput`](../interfaces/SexVidVideoOutput.md)\>

`Promise<SexVidVideoOutput>` with video metadata and source URLs.
