...
[downflux](../README.md) / BlackPornProvider

# Class: BlackPornProvider

Defined in: [packages/providers/blackporn/BlackPornProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/blackporn/BlackPornProvider.ts#L16)
...
- [`BaseProvider`](BaseProvider.md)\<[`BlackPornExecArgs`](../interfaces/BlackPornExecArgs.md)\>

## Constructors

### Constructor

> **new BlackPornProvider**(`url`): `BlackPornProvider`

Defined in: [packages/providers/blackporn/BlackPornProvider.ts:20](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/blackporn/BlackPornProvider.ts#L20)
...
> `protected` `readonly` **provider**: [`BlackPorn`](../enumerations/Provider.md#blackporn) = `Provider.BlackPorn`

Defined in: [packages/providers/blackporn/BlackPornProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/blackporn/BlackPornProvider.ts#L17)
...
> `protected` **buildRequest**(`overrides?`): [`BlackPornExecArgs`](../interfaces/BlackPornExecArgs.md)
...
`Partial`\<[`BlackPornExecArgs`](../interfaces/BlackPornExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`BlackPornExecArgs`](../interfaces/BlackPornExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`BlackPornVideoOutput`](../interfaces/BlackPornVideoOutput.md)\>

Defined in: [packages/providers/blackporn/BlackPornProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/blackporn/BlackPornProvider.ts#L45)

#### Returns

`Promise`\<[`BlackPornVideoOutput`](../interfaces/BlackPornVideoOutput.md)\>
