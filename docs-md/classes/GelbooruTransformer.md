...
[downflux](../README.md) / GelbooruTransformer

# Class: GelbooruTransformer

Defined in: [packages/providers/gelbooru/GelbooruTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/gelbooru/GelbooruTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`GelbooruExecArgs`](../interfaces/GelbooruExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new GelbooruTransformer**(`httpClient`, `progressManager`): `GelbooruTransformer`
...
Defined in: [packages/providers/gelbooru/GelbooruTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/gelbooru/GelbooruTransformer.ts#L9)
