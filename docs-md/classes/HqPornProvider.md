...
[downflux](../README.md) / HqPornProvider

# Class: HqPornProvider

Defined in: [packages/providers/hqporn/HqPornProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/hqporn/HqPornProvider.ts#L17)
...
- [`BaseProvider`](BaseProvider.md)\<[`HqPornExecArgs`](../interfaces/HqPornExecArgs.md)\>

## Constructors

### Constructor

> **new HqPornProvider**(`url`): `HqPornProvider`

Defined in: [packages/providers/hqporn/HqPornProvider.ts:20](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/hqporn/HqPornProvider.ts#L20)
...
> `protected` `readonly` **provider**: [`HqPorn`](../enumerations/Provider.md#hqporn) = `Provider.HqPorn`

Defined in: [packages/providers/hqporn/HqPornProvider.ts:18](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/hqporn/HqPornProvider.ts#L18)
...
> `protected` **buildRequest**(`overrides?`): [`HqPornExecArgs`](../interfaces/HqPornExecArgs.md)
...
`Partial`\<[`HqPornExecArgs`](../interfaces/HqPornExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`HqPornExecArgs`](../interfaces/HqPornExecArgs.md) & `object`
...
> **getVideo**(`quality?`): `Promise`\<[`HqPornVideoOutput`](../interfaces/HqPornVideoOutput.md)\>

Defined in: [packages/providers/hqporn/HqPornProvider.ts:49](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/hqporn/HqPornProvider.ts#L49)
...
`Promise`\<[`HqPornVideoOutput`](../interfaces/HqPornVideoOutput.md)\>

`HqPornVideoOutput` containing video metadata and download URL.

#### Throws

`InvalidUrlException` if the URL is not a valid HqPorn video page URL.

#### Throws

`GenericException` for any parsing or extraction errors.
