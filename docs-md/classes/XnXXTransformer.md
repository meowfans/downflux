...
[downflux](../README.md) / XnXXTransformer

# Class: XnXXTransformer

Defined in: [packages/providers/xnxx/XnXXTransformer.ts:12](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xnxx/XnXXTransformer.ts#L12)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`XnXXExecArgs`](../interfaces/XnXXExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`XnXXVideoOutput`](../interfaces/XnXXVideoOutput.md)\>

## Constructors

### Constructor

> **new XnXXTransformer**(`httpClient`, `progressManager`): `XnXXTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`XnXXVideoOutput`](../interfaces/XnXXVideoOutput.md)\>

Defined in: [packages/providers/xnxx/XnXXTransformer.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xnxx/XnXXTransformer.ts#L13)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`XnXXVideoOutput`](../interfaces/XnXXVideoOutput.md)\>
