...
[downflux](../README.md) / MangaDexParser

# Class: MangaDexParser

Defined in: [packages/providers/mangadex/MangaDexParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mangadex/MangaDexParser.ts#L7)
...
> **new MangaDexParser**(): `MangaDexParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`MangaDexOutput`](../interfaces/MangaDexOutput.md)\>\>\>

Defined in: [packages/providers/mangadex/MangaDexParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mangadex/MangaDexParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`MangaDexOutput`](../interfaces/MangaDexOutput.md)\>\>\>
