...
[downflux](../README.md) / XCafeParser

# Class: XCafeParser

Defined in: [packages/providers/xcafe/XCafeParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xcafe/XCafeParser.ts#L13)
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`XCafeOutput`](../interfaces/XCafeOutput.md)\>\>\>

Defined in: [packages/providers/xcafe/XCafeParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xcafe/XCafeParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`XCafeOutput`](../interfaces/XCafeOutput.md)\>\>\>
