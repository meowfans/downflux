...
[downflux](../README.md) / DaNudeTransformer

# Class: DaNudeTransformer

Defined in: [packages/providers/danude/DaNudeTransformer.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danude/DaNudeTransformer.ts#L14)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`DaNudeExecArgs`](../interfaces/DaNudeExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`DaNudeVideoOutput`](../interfaces/DaNudeVideoOutput.md)\>

## Constructors

### Constructor

> **new DaNudeTransformer**(`httpClient`, `progressManager`): `DaNudeTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`DaNudeVideoOutput`](../interfaces/DaNudeVideoOutput.md)\>

Defined in: [packages/providers/danude/DaNudeTransformer.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danude/DaNudeTransformer.ts#L15)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`DaNudeVideoOutput`](../interfaces/DaNudeVideoOutput.md)\>
