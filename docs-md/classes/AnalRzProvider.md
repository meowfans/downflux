...
[downflux](../README.md) / AnalRzProvider

# Class: AnalRzProvider

Defined in: [packages/providers/analrz/AnalRzProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/analrz/AnalRzProvider.ts#L16)
...
- [`BaseProvider`](BaseProvider.md)\<[`AnalRzExecArgs`](../interfaces/AnalRzExecArgs.md)\>

## Constructors

### Constructor

> **new AnalRzProvider**(`url`): `AnalRzProvider`

Defined in: [packages/providers/analrz/AnalRzProvider.ts:20](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/analrz/AnalRzProvider.ts#L20)
...
> `protected` `readonly` **provider**: [`AnalRz`](../enumerations/Provider.md#analrz) = `Provider.AnalRz`

Defined in: [packages/providers/analrz/AnalRzProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/analrz/AnalRzProvider.ts#L17)
...
> `protected` **buildRequest**(`overrides?`): [`AnalRzExecArgs`](../interfaces/AnalRzExecArgs.md)
...
`Partial`\<[`AnalRzExecArgs`](../interfaces/AnalRzExecArgs.md)\>
...
[`AnalRzExecArgs`](../interfaces/AnalRzExecArgs.md) \| \{ `entryUrl?`: `string`; \} & `object`
...
> **getVideo**(): `Promise`\<[`AnalRzVideoOutput`](../interfaces/AnalRzVideoOutput.md)\>

Defined in: [packages/providers/analrz/AnalRzProvider.ts:47](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/analrz/AnalRzProvider.ts#L47)

#### Returns

`Promise`\<[`AnalRzVideoOutput`](../interfaces/AnalRzVideoOutput.md)\>
