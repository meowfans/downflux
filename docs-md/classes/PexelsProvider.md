...
[downflux](../README.md) / PexelsProvider

# Class: PexelsProvider

Defined in: [packages/providers/pexels/PexelsProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pexels/PexelsProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`PexelsExecArgs`](../interfaces/PexelsExecArgs.md)\>

## Constructors

### Constructor

> **new PexelsProvider**(`url`): `PexelsProvider`

Defined in: [packages/providers/pexels/PexelsProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pexels/PexelsProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`PexelsExecArgs`](../interfaces/PexelsExecArgs.md)
...
`Partial`\<[`PexelsExecArgs`](../interfaces/PexelsExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`PexelsExecArgs`](../interfaces/PexelsExecArgs.md) & `object`
