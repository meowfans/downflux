...
[downflux](../README.md) / BlueskyParser

# Class: BlueskyParser

Defined in: [packages/providers/bluesky/BlueskyParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bluesky/BlueskyParser.ts#L7)
...
> **new BlueskyParser**(): `BlueskyParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`BlueskyOutput`](../interfaces/BlueskyOutput.md)\>\>\>

Defined in: [packages/providers/bluesky/BlueskyParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bluesky/BlueskyParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`BlueskyOutput`](../interfaces/BlueskyOutput.md)\>\>\>
