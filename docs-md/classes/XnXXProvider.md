...
[downflux](../README.md) / XnXXProvider

# Class: XnXXProvider

Defined in: [packages/providers/xnxx/XnXXProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xnxx/XnXXProvider.ts#L16)
...
- [`BaseProvider`](BaseProvider.md)\<[`XnXXExecArgs`](../interfaces/XnXXExecArgs.md)\>

## Constructors

### Constructor

> **new XnXXProvider**(`url`): `XnXXProvider`

Defined in: [packages/providers/xnxx/XnXXProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xnxx/XnXXProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`XnXX`](../enumerations/Provider.md#xnxx) = `Provider.XnXX`

Defined in: [packages/providers/xnxx/XnXXProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xnxx/XnXXProvider.ts#L17)
...
> `protected` **buildRequest**(`overrides?`): [`XnXXExecArgs`](../interfaces/XnXXExecArgs.md)
...
`Partial`\<[`XnXXExecArgs`](../interfaces/XnXXExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`XnXXExecArgs`](../interfaces/XnXXExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`XnXXVideoOutput`](../interfaces/XnXXVideoOutput.md)\>

Defined in: [packages/providers/xnxx/XnXXProvider.ts:46](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xnxx/XnXXProvider.ts#L46)

#### Returns

`Promise`\<[`XnXXVideoOutput`](../interfaces/XnXXVideoOutput.md)\>

`XnXXVideoOutput` with video metadata and source URLs.
