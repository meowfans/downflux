...
[downflux](../README.md) / EpicGfsTransformer

# Class: EpicGfsTransformer

Defined in: [packages/providers/epicgfs/EpicGfsTransformer.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/epicgfs/EpicGfsTransformer.ts#L14)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`EpicGfsExecArgs`](../interfaces/EpicGfsExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`EpicGfsVideoOutput`](../interfaces/EpicGfsVideoOutput.md)\>

## Constructors

### Constructor

> **new EpicGfsTransformer**(`httpClient`, `progressManager`): `EpicGfsTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`EpicGfsVideoOutput`](../interfaces/EpicGfsVideoOutput.md)\>

Defined in: [packages/providers/epicgfs/EpicGfsTransformer.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/epicgfs/EpicGfsTransformer.ts#L15)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`EpicGfsVideoOutput`](../interfaces/EpicGfsVideoOutput.md)\>
