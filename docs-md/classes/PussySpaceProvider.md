...
[downflux](../README.md) / PussySpaceProvider

# Class: PussySpaceProvider

Defined in: [packages/providers/pussyspace/PussySpaceProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pussyspace/PussySpaceProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`PussySpaceExecArgs`](../interfaces/PussySpaceExecArgs.md)\>

## Constructors

### Constructor

> **new PussySpaceProvider**(`url`): `PussySpaceProvider`

Defined in: [packages/providers/pussyspace/PussySpaceProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pussyspace/PussySpaceProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`PussySpace`](../enumerations/Provider.md#pussyspace) = `Provider.PussySpace`

Defined in: [packages/providers/pussyspace/PussySpaceProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pussyspace/PussySpaceProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`PussySpaceExecArgs`](../interfaces/PussySpaceExecArgs.md)
...
`Partial`\<[`PussySpaceExecArgs`](../interfaces/PussySpaceExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`PussySpaceExecArgs`](../interfaces/PussySpaceExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`PussySpaceVideoOutput`](../interfaces/PussySpaceVideoOutput.md)\>

Defined in: [packages/providers/pussyspace/PussySpaceProvider.ts:48](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pussyspace/PussySpaceProvider.ts#L48)

#### Returns

`Promise`\<[`PussySpaceVideoOutput`](../interfaces/PussySpaceVideoOutput.md)\>
