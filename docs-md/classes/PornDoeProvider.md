...
[downflux](../README.md) / PornDoeProvider

# Class: PornDoeProvider

Defined in: [packages/providers/porndoe/PornDoeProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`PornDoeExecArgs`](../interfaces/PornDoeExecArgs.md)\>

## Constructors

### Constructor

> **new PornDoeProvider**(`url`): `PornDoeProvider`

Defined in: [packages/providers/porndoe/PornDoeProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`PornDoe`](../enumerations/Provider.md#porndoe) = `Provider.PornDoe`

Defined in: [packages/providers/porndoe/PornDoeProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`PornDoeExecArgs`](../interfaces/PornDoeExecArgs.md)
...
`Partial`\<[`PornDoeExecArgs`](../interfaces/PornDoeExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`PornDoeExecArgs`](../interfaces/PornDoeExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`PornDoeVideoOutput`](../interfaces/PornDoeVideoOutput.md)\>

Defined in: [packages/providers/porndoe/PornDoeProvider.ts:48](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeProvider.ts#L48)

#### Returns

`Promise`\<[`PornDoeVideoOutput`](../interfaces/PornDoeVideoOutput.md)\>
