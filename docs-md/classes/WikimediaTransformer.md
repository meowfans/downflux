...
[downflux](../README.md) / WikimediaTransformer

# Class: WikimediaTransformer

Defined in: [packages/providers/wikimedia/WikimediaTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikimedia/WikimediaTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`WikimediaExecArgs`](../interfaces/WikimediaExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new WikimediaTransformer**(`httpClient`, `progressManager`): `WikimediaTransformer`
...
Defined in: [packages/providers/wikimedia/WikimediaTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikimedia/WikimediaTransformer.ts#L9)
