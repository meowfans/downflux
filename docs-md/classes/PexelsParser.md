...
[downflux](../README.md) / PexelsParser

# Class: PexelsParser

Defined in: [packages/providers/pexels/PexelsParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pexels/PexelsParser.ts#L7)
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PexelsOutput`](../interfaces/PexelsOutput.md)\>\>\>

Defined in: [packages/providers/pexels/PexelsParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pexels/PexelsParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PexelsOutput`](../interfaces/PexelsOutput.md)\>\>\>
