...
[downflux](../README.md) / PixivProvider

# Class: PixivProvider

Defined in: [packages/providers/pixiv/PixivProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pixiv/PixivProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`PixivExecArgs`](../interfaces/PixivExecArgs.md)\>

## Constructors

### Constructor

> **new PixivProvider**(`url`): `PixivProvider`

Defined in: [packages/providers/pixiv/PixivProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pixiv/PixivProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`PixivExecArgs`](../interfaces/PixivExecArgs.md)
...
`Partial`\<[`PixivExecArgs`](../interfaces/PixivExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`PixivExecArgs`](../interfaces/PixivExecArgs.md) & `object`
