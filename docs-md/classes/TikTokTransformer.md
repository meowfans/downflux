...
[downflux](../README.md) / TikTokTransformer
...
- [`BaseTransformer`](BaseTransformer.md)\<[`TikTokExecArgs`](../interfaces/TikTokExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>
