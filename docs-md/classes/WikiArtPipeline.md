...
[downflux](../README.md) / WikiArtPipeline

# Class: WikiArtPipeline

Defined in: [packages/providers/wikiart/WikiArtPipeline.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikiart/WikiArtPipeline.ts#L7)
...
- [`BasePipeline`](BasePipeline.md)\<[`WikiArtExecArgs`](../interfaces/WikiArtExecArgs.md), [`WikiArtOutput`](../interfaces/WikiArtOutput.md)\>

## Constructors

### Constructor

> **new WikiArtPipeline**(`fileManager`): `WikiArtPipeline`
...
Defined in: [packages/providers/wikiart/WikiArtPipeline.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikiart/WikiArtPipeline.ts#L8)
...
[`IdentifierContext`](../interfaces/IdentifierContext.md)\<[`WikiArtOutput`](../interfaces/WikiArtOutput.md)\>
