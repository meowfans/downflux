...
[downflux](../README.md) / ShamelessParser

# Class: ShamelessParser

Defined in: [packages/providers/shameless/ShamelessParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/shameless/ShamelessParser.ts#L13)
...
> **new ShamelessParser**(): `ShamelessParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ShamelessOutput`](../interfaces/ShamelessOutput.md)\>\>\>

Defined in: [packages/providers/shameless/ShamelessParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/shameless/ShamelessParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ShamelessOutput`](../interfaces/ShamelessOutput.md)\>\>\>
