...
[downflux](../README.md) / PornsOkParser

# Class: PornsOkParser

Defined in: [packages/providers/pornsok/PornsOkParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornsok/PornsOkParser.ts#L13)
...
> **new PornsOkParser**(): `PornsOkParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PornsOkOutput`](../interfaces/PornsOkOutput.md)\>\>\>

Defined in: [packages/providers/pornsok/PornsOkParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornsok/PornsOkParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PornsOkOutput`](../interfaces/PornsOkOutput.md)\>\>\>
