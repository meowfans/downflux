...
[downflux](../README.md) / XozillaProvider

# Class: XozillaProvider

Defined in: [packages/providers/xozilla/XozillaProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xozilla/XozillaProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`XozillaExecArgs`](../interfaces/XozillaExecArgs.md)\>

## Constructors

### Constructor

> **new XozillaProvider**(`url`): `XozillaProvider`

Defined in: [packages/providers/xozilla/XozillaProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xozilla/XozillaProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`Xozilla`](../enumerations/Provider.md#xozilla) = `Provider.Xozilla`

Defined in: [packages/providers/xozilla/XozillaProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xozilla/XozillaProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`XozillaExecArgs`](../interfaces/XozillaExecArgs.md)
...
`Partial`\<[`XozillaExecArgs`](../interfaces/XozillaExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`XozillaExecArgs`](../interfaces/XozillaExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`XozillaVideoOutput`](../interfaces/XozillaVideoOutput.md)\>

Defined in: [packages/providers/xozilla/XozillaProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xozilla/XozillaProvider.ts#L45)

#### Returns

`Promise`\<[`XozillaVideoOutput`](../interfaces/XozillaVideoOutput.md)\>
