...
[downflux](../README.md) / BehanceTransformer

# Class: BehanceTransformer

Defined in: [packages/providers/behance/BehanceTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/behance/BehanceTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`BehanceExecArgs`](../interfaces/BehanceExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new BehanceTransformer**(`httpClient`, `progressManager`): `BehanceTransformer`
...
Defined in: [packages/providers/behance/BehanceTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/behance/BehanceTransformer.ts#L9)
