...
[downflux](../README.md) / EPornerParser

# Class: EPornerParser

Defined in: [packages/providers/eporner/EPornerParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/eporner/EPornerParser.ts#L13)
...
> **new EPornerParser**(): `EPornerParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`EPornerOutput`](../interfaces/EPornerOutput.md)\>\>\>

Defined in: [packages/providers/eporner/EPornerParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/eporner/EPornerParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`EPornerOutput`](../interfaces/EPornerOutput.md)\>\>\>
