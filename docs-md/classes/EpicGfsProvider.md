...
[downflux](../README.md) / EpicGfsProvider

# Class: EpicGfsProvider

Defined in: [packages/providers/epicgfs/EpicGfsProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/epicgfs/EpicGfsProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`EpicGfsExecArgs`](../interfaces/EpicGfsExecArgs.md)\>

## Constructors

### Constructor

> **new EpicGfsProvider**(`url`): `EpicGfsProvider`

Defined in: [packages/providers/epicgfs/EpicGfsProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/epicgfs/EpicGfsProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`EpicGfs`](../enumerations/Provider.md#epicgfs) = `Provider.EpicGfs`

Defined in: [packages/providers/epicgfs/EpicGfsProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/epicgfs/EpicGfsProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`EpicGfsExecArgs`](../interfaces/EpicGfsExecArgs.md)
...
`Partial`\<[`EpicGfsExecArgs`](../interfaces/EpicGfsExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`EpicGfsExecArgs`](../interfaces/EpicGfsExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`EpicGfsVideoOutput`](../interfaces/EpicGfsVideoOutput.md)\>

Defined in: [packages/providers/epicgfs/EpicGfsProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/epicgfs/EpicGfsProvider.ts#L45)

#### Returns

`Promise`\<[`EpicGfsVideoOutput`](../interfaces/EpicGfsVideoOutput.md)\>
