...
[downflux](../README.md) / GelbooruProvider

# Class: GelbooruProvider

Defined in: [packages/providers/gelbooru/GelbooruProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/gelbooru/GelbooruProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`GelbooruExecArgs`](../interfaces/GelbooruExecArgs.md)\>

## Constructors

### Constructor

> **new GelbooruProvider**(`url`): `GelbooruProvider`

Defined in: [packages/providers/gelbooru/GelbooruProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/gelbooru/GelbooruProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`GelbooruExecArgs`](../interfaces/GelbooruExecArgs.md)
...
`Partial`\<[`GelbooruExecArgs`](../interfaces/GelbooruExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`GelbooruExecArgs`](../interfaces/GelbooruExecArgs.md) & `object`
