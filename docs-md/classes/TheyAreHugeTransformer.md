...
[downflux](../README.md) / TheyAreHugeTransformer

# Class: TheyAreHugeTransformer

Defined in: [packages/providers/theyarehuge/TheyAreHugeTransformer.ts:12](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/theyarehuge/TheyAreHugeTransformer.ts#L12)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`TheyAreHugeExecArgs`](../interfaces/TheyAreHugeExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`TheyAreHugeVideoOutput`](../interfaces/TheyAreHugeVideoOutput.md)\>

## Constructors

### Constructor

> **new TheyAreHugeTransformer**(`httpClient`, `progressManager`): `TheyAreHugeTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`TheyAreHugeVideoOutput`](../interfaces/TheyAreHugeVideoOutput.md)\>

Defined in: [packages/providers/theyarehuge/TheyAreHugeTransformer.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/theyarehuge/TheyAreHugeTransformer.ts#L13)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`TheyAreHugeVideoOutput`](../interfaces/TheyAreHugeVideoOutput.md)\>
