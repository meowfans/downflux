...
[downflux](../README.md) / ItsPornTransformer

# Class: ItsPornTransformer

Defined in: [packages/providers/itsporn/ItsPornTransformer.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/itsporn/ItsPornTransformer.ts#L14)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`ItsPornExecArgs`](../interfaces/ItsPornExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`ItsPornVideoOutput`](../interfaces/ItsPornVideoOutput.md)\>

## Constructors

### Constructor

> **new ItsPornTransformer**(`httpClient`, `progressManager`): `ItsPornTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`ItsPornVideoOutput`](../interfaces/ItsPornVideoOutput.md)\>

Defined in: [packages/providers/itsporn/ItsPornTransformer.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/itsporn/ItsPornTransformer.ts#L15)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`ItsPornVideoOutput`](../interfaces/ItsPornVideoOutput.md)\>
