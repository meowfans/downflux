...
[downflux](../README.md) / EpicGfsParser

# Class: EpicGfsParser

Defined in: [packages/providers/epicgfs/EpicGfsParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/epicgfs/EpicGfsParser.ts#L13)
...
> **new EpicGfsParser**(): `EpicGfsParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`EpicGfsOutput`](../interfaces/EpicGfsOutput.md)\>\>\>

Defined in: [packages/providers/epicgfs/EpicGfsParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/epicgfs/EpicGfsParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`EpicGfsOutput`](../interfaces/EpicGfsOutput.md)\>\>\>
