...
[downflux](../README.md) / SuperPornProvider

# Class: SuperPornProvider

Defined in: [packages/providers/superporn/SuperPornProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/superporn/SuperPornProvider.ts#L16)
...
- [`BaseProvider`](BaseProvider.md)\<[`SuperPornExecArgs`](../interfaces/SuperPornExecArgs.md)\>

## Constructors

### Constructor

> **new SuperPornProvider**(`url`): `SuperPornProvider`

Defined in: [packages/providers/superporn/SuperPornProvider.ts:20](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/superporn/SuperPornProvider.ts#L20)
...
> `protected` `readonly` **provider**: [`SuperPorn`](../enumerations/Provider.md#superporn) = `Provider.SuperPorn`

Defined in: [packages/providers/superporn/SuperPornProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/superporn/SuperPornProvider.ts#L17)
...
> `protected` **buildRequest**(`overrides?`): [`SuperPornExecArgs`](../interfaces/SuperPornExecArgs.md)
...
`Partial`\<[`SuperPornExecArgs`](../interfaces/SuperPornExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`SuperPornExecArgs`](../interfaces/SuperPornExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`SuperPornVideoOutput`](../interfaces/SuperPornVideoOutput.md)\>

Defined in: [packages/providers/superporn/SuperPornProvider.ts:53](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/superporn/SuperPornProvider.ts#L53)

#### Returns

`Promise`\<[`SuperPornVideoOutput`](../interfaces/SuperPornVideoOutput.md)\>

`SuperPornVideoOutput` with video metadata and source URLs.
