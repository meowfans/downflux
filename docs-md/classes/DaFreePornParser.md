...
[downflux](../README.md) / DaFreePornParser

# Class: DaFreePornParser

Defined in: [packages/providers/dafreeporn/DaFreePornParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/dafreeporn/DaFreePornParser.ts#L13)
...
> **new DaFreePornParser**(): `DaFreePornParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`DaFreePornOutput`](../interfaces/DaFreePornOutput.md)\>\>\>

Defined in: [packages/providers/dafreeporn/DaFreePornParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/dafreeporn/DaFreePornParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`DaFreePornOutput`](../interfaces/DaFreePornOutput.md)\>\>\>
