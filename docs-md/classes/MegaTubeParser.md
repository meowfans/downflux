...
[downflux](../README.md) / MegaTubeParser

# Class: MegaTubeParser

Defined in: [packages/providers/megatube/MegaTubeParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/megatube/MegaTubeParser.ts#L13)
...
> **new MegaTubeParser**(): `MegaTubeParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`MegaTubeOutput`](../interfaces/MegaTubeOutput.md)\>\>\>

Defined in: [packages/providers/megatube/MegaTubeParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/megatube/MegaTubeParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`MegaTubeOutput`](../interfaces/MegaTubeOutput.md)\>\>\>
