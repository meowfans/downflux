...
[downflux](../README.md) / XozillaParser

# Class: XozillaParser

Defined in: [packages/providers/xozilla/XozillaParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xozilla/XozillaParser.ts#L13)
...
> **new XozillaParser**(): `XozillaParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`XozillaOutput`](../interfaces/XozillaOutput.md)\>\>\>

Defined in: [packages/providers/xozilla/XozillaParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xozilla/XozillaParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`XozillaOutput`](../interfaces/XozillaOutput.md)\>\>\>
