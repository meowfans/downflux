...
[downflux](../README.md) / BoKepPornTransformer

# Class: BoKepPornTransformer

Defined in: [packages/providers/bokepporn/BoKepPornTransformer.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bokepporn/BoKepPornTransformer.ts#L14)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`BoKepPornExecArgs`](../interfaces/BoKepPornExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`BoKepPornVideoOutput`](../interfaces/BoKepPornVideoOutput.md)\>

## Constructors

### Constructor

> **new BoKepPornTransformer**(`httpClient`, `progressManager`): `BoKepPornTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`BoKepPornVideoOutput`](../interfaces/BoKepPornVideoOutput.md)\>

Defined in: [packages/providers/bokepporn/BoKepPornTransformer.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bokepporn/BoKepPornTransformer.ts#L15)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`BoKepPornVideoOutput`](../interfaces/BoKepPornVideoOutput.md)\>
