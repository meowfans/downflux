...
[downflux](../README.md) / CumLouderParser

# Class: CumLouderParser

Defined in: [packages/providers/cumlouder/CumLouderParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/cumlouder/CumLouderParser.ts#L13)
...
> **new CumLouderParser**(): `CumLouderParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`CumLouderOutput`](../interfaces/CumLouderOutput.md)\>\>\>

Defined in: [packages/providers/cumlouder/CumLouderParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/cumlouder/CumLouderParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`CumLouderOutput`](../interfaces/CumLouderOutput.md)\>\>\>
