...
[downflux](../README.md) / MegaTubeProvider

# Class: MegaTubeProvider

Defined in: [packages/providers/megatube/MegaTubeProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/megatube/MegaTubeProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`MegaTubeExecArgs`](../interfaces/MegaTubeExecArgs.md)\>

## Constructors

### Constructor

> **new MegaTubeProvider**(`url`): `MegaTubeProvider`

Defined in: [packages/providers/megatube/MegaTubeProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/megatube/MegaTubeProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`MegaTube`](../enumerations/Provider.md#megatube) = `Provider.MegaTube`

Defined in: [packages/providers/megatube/MegaTubeProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/megatube/MegaTubeProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`MegaTubeExecArgs`](../interfaces/MegaTubeExecArgs.md)
...
`Partial`\<[`MegaTubeExecArgs`](../interfaces/MegaTubeExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`MegaTubeExecArgs`](../interfaces/MegaTubeExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`MegaTubeVideoOutput`](../interfaces/MegaTubeVideoOutput.md)\>

Defined in: [packages/providers/megatube/MegaTubeProvider.ts:48](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/megatube/MegaTubeProvider.ts#L48)

#### Returns

`Promise`\<[`MegaTubeVideoOutput`](../interfaces/MegaTubeVideoOutput.md)\>
