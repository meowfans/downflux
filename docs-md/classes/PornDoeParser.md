...
[downflux](../README.md) / PornDoeParser

# Class: PornDoeParser

Defined in: [packages/providers/porndoe/PornDoeParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeParser.ts#L13)
...
> **new PornDoeParser**(): `PornDoeParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PornDoeOutput`](../interfaces/PornDoeOutput.md)\>\>\>

Defined in: [packages/providers/porndoe/PornDoeParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PornDoeOutput`](../interfaces/PornDoeOutput.md)\>\>\>
