...
[downflux](../README.md) / ColliderPornProvider

# Class: ColliderPornProvider

Defined in: [packages/providers/colliderporn/ColliderPornProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/colliderporn/ColliderPornProvider.ts#L16)
...
- [`BaseProvider`](BaseProvider.md)\<[`ColliderPornExecArgs`](../interfaces/ColliderPornExecArgs.md)\>

## Constructors

### Constructor

> **new ColliderPornProvider**(`url`): `ColliderPornProvider`

Defined in: [packages/providers/colliderporn/ColliderPornProvider.ts:25](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/colliderporn/ColliderPornProvider.ts#L25)
...
> `protected` `readonly` **provider**: [`ColliderPorn`](../enumerations/Provider.md#colliderporn) = `Provider.ColliderPorn`

Defined in: [packages/providers/colliderporn/ColliderPornProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/colliderporn/ColliderPornProvider.ts#L17)
...
> `protected` **buildRequest**(`overrides?`): [`ColliderPornExecArgs`](../interfaces/ColliderPornExecArgs.md)
...
`Partial`\<[`ColliderPornExecArgs`](../interfaces/ColliderPornExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`ColliderPornExecArgs`](../interfaces/ColliderPornExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`ColliderPornVideoOutput`](../interfaces/ColliderPornVideoOutput.md)\>

Defined in: [packages/providers/colliderporn/ColliderPornProvider.ts:53](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/colliderporn/ColliderPornProvider.ts#L53)

#### Returns

`Promise`\<[`ColliderPornVideoOutput`](../interfaces/ColliderPornVideoOutput.md)\>
