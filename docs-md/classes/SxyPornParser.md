...
[downflux](../README.md) / SxyPornParser

# Class: SxyPornParser

Defined in: [packages/providers/sxyporn/SxyPornParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sxyporn/SxyPornParser.ts#L13)
...
> **new SxyPornParser**(): `SxyPornParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`SxyPornOutput`](../interfaces/SxyPornOutput.md)\>\>\>

Defined in: [packages/providers/sxyporn/SxyPornParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sxyporn/SxyPornParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`SxyPornOutput`](../interfaces/SxyPornOutput.md)\>\>\>
