...
[downflux](../README.md) / DaFreePornProvider

# Class: DaFreePornProvider

Defined in: [packages/providers/dafreeporn/DaFreePornProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/dafreeporn/DaFreePornProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`DaFreePornExecArgs`](../interfaces/DaFreePornExecArgs.md)\>

## Constructors

### Constructor

> **new DaFreePornProvider**(`url`): `DaFreePornProvider`

Defined in: [packages/providers/dafreeporn/DaFreePornProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/dafreeporn/DaFreePornProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`DaFreePorn`](../enumerations/Provider.md#dafreeporn) = `Provider.DaFreePorn`

Defined in: [packages/providers/dafreeporn/DaFreePornProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/dafreeporn/DaFreePornProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`DaFreePornExecArgs`](../interfaces/DaFreePornExecArgs.md)
...
`Partial`\<[`DaFreePornExecArgs`](../interfaces/DaFreePornExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`DaFreePornExecArgs`](../interfaces/DaFreePornExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`DaFreePornVideoOutput`](../interfaces/DaFreePornVideoOutput.md)\>

Defined in: [packages/providers/dafreeporn/DaFreePornProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/dafreeporn/DaFreePornProvider.ts#L45)

#### Returns

`Promise`\<[`DaFreePornVideoOutput`](../interfaces/DaFreePornVideoOutput.md)\>
