...
[downflux](../README.md) / TwitterProvider

# Class: TwitterProvider

Defined in: [packages/providers/twitter/TwitterProvider.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterProvider.ts#L9)
...
- [`BaseProvider`](BaseProvider.md)\<[`TwitterExecArgs`](../interfaces/TwitterExecArgs.md)\>

## Constructors

### Constructor

> **new TwitterProvider**(`url`): `TwitterProvider`

Defined in: [packages/providers/twitter/TwitterProvider.ts:12](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterProvider.ts#L12)
...
> `protected` `readonly` **provider**: [`Twitter`](../enumerations/Provider.md#twitter) = `Provider.Twitter`

Defined in: [packages/providers/twitter/TwitterProvider.ts:10](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterProvider.ts#L10)
...
> `protected` **buildRequest**(`overrides?`): [`TwitterExecArgs`](../interfaces/TwitterExecArgs.md)
...
`Partial`\<[`TwitterExecArgs`](../interfaces/TwitterExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`TwitterExecArgs`](../interfaces/TwitterExecArgs.md) & `object`
...
> **getPost**(`tweetId?`, `username?`): `Promise`\<[`TwitterPostOutput`](../interfaces/TwitterPostOutput.md)\>

Defined in: [packages/providers/twitter/TwitterProvider.ts:91](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterProvider.ts#L91)
...
`Promise`\<[`TwitterPostOutput`](../interfaces/TwitterPostOutput.md)\>

***

### getUserPosts()

> **getUserPosts**(`args?`, `range?`): `Promise`\<[`TwitterTimelineOutput`](../interfaces/TwitterTimelineOutput.md)[]\>

Defined in: [packages/providers/twitter/TwitterProvider.ts:109](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterProvider.ts#L109)
...
[`TwitterApiTimelineArgs`](../interfaces/TwitterApiTimelineArgs.md) & `object` = `{}`

##### range?

[`PageRange`](../type-aliases/PageRange.md) = `DEFAULT_PAGE_RANGE`

#### Returns

`Promise`\<[`TwitterTimelineOutput`](../interfaces/TwitterTimelineOutput.md)[]\>

***

### getUserMedia()

> **getUserMedia**(`args?`, `range?`): `Promise`\<[`TwitterTimelineOutput`](../interfaces/TwitterTimelineOutput.md)[]\>

Defined in: [packages/providers/twitter/TwitterProvider.ts:133](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterProvider.ts#L133)
...
> **getUserLikes**(`args?`, `range?`): `Promise`\<[`TwitterTimelineOutput`](../interfaces/TwitterTimelineOutput.md)[]\>

Defined in: [packages/providers/twitter/TwitterProvider.ts:162](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterProvider.ts#L162)
...
> **getSearch**(`args`, `range?`): `Promise`\<[`TwitterTimelineOutput`](../interfaces/TwitterTimelineOutput.md)[]\>

Defined in: [packages/providers/twitter/TwitterProvider.ts:191](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterProvider.ts#L191)
