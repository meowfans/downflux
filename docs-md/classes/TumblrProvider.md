...
[downflux](../README.md) / TumblrProvider

# Class: TumblrProvider

Defined in: [packages/providers/tumblr/TumblrProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/tumblr/TumblrProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`TumblrExecArgs`](../interfaces/TumblrExecArgs.md)\>

## Constructors

### Constructor

> **new TumblrProvider**(`url`): `TumblrProvider`

Defined in: [packages/providers/tumblr/TumblrProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/tumblr/TumblrProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`TumblrExecArgs`](../interfaces/TumblrExecArgs.md)
...
`Partial`\<[`TumblrExecArgs`](../interfaces/TumblrExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`TumblrExecArgs`](../interfaces/TumblrExecArgs.md) & `object`
