...
[downflux](../README.md) / MastodonPipeline
...
- [`BasePipeline`](BasePipeline.md)\<[`MastodonExecArgs`](../interfaces/MastodonExecArgs.md), [`MastodonOutput`](../interfaces/MastodonOutput.md)\>
...
[`IdentifierContext`](../interfaces/IdentifierContext.md)\<[`MastodonOutput`](../interfaces/MastodonOutput.md)\>
