...
[downflux](../README.md) / XCafeProvider

# Class: XCafeProvider

Defined in: [packages/providers/xcafe/XCafeProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xcafe/XCafeProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`XCafeExecArgs`](../interfaces/XCafeExecArgs.md)\>

## Constructors

### Constructor

> **new XCafeProvider**(`url`): `XCafeProvider`

Defined in: [packages/providers/xcafe/XCafeProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xcafe/XCafeProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`XCafe`](../enumerations/Provider.md#xcafe) = `Provider.XCafe`

Defined in: [packages/providers/xcafe/XCafeProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xcafe/XCafeProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`XCafeExecArgs`](../interfaces/XCafeExecArgs.md)
...
`Partial`\<[`XCafeExecArgs`](../interfaces/XCafeExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`XCafeExecArgs`](../interfaces/XCafeExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`XCafeVideoOutput`](../interfaces/XCafeVideoOutput.md)\>

Defined in: [packages/providers/xcafe/XCafeProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xcafe/XCafeProvider.ts#L45)

#### Returns

`Promise`\<[`XCafeVideoOutput`](../interfaces/XCafeVideoOutput.md)\>
