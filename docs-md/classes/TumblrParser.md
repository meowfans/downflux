...
[downflux](../README.md) / TumblrParser

# Class: TumblrParser

Defined in: [packages/providers/tumblr/TumblrParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/tumblr/TumblrParser.ts#L7)
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`TumblrOutput`](../interfaces/TumblrOutput.md)\>\>\>

Defined in: [packages/providers/tumblr/TumblrParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/tumblr/TumblrParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`TumblrOutput`](../interfaces/TumblrOutput.md)\>\>\>
