...
[downflux](../README.md) / InstagramProvider

# Class: InstagramProvider

Defined in: [packages/providers/instagram/InstagramProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/instagram/InstagramProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`InstagramExecArgs`](../interfaces/InstagramExecArgs.md)\>

## Constructors

### Constructor

> **new InstagramProvider**(`url`): `InstagramProvider`

Defined in: [packages/providers/instagram/InstagramProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/instagram/InstagramProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`InstagramExecArgs`](../interfaces/InstagramExecArgs.md)
...
`Partial`\<[`InstagramExecArgs`](../interfaces/InstagramExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`InstagramExecArgs`](../interfaces/InstagramExecArgs.md) & `object`
