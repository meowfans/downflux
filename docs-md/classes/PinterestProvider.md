...
[downflux](../README.md) / PinterestProvider

# Class: PinterestProvider

Defined in: [packages/providers/pinterest/PinterestProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pinterest/PinterestProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`PinterestExecArgs`](../interfaces/PinterestExecArgs.md)\>

## Constructors

### Constructor

> **new PinterestProvider**(`url`): `PinterestProvider`

Defined in: [packages/providers/pinterest/PinterestProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pinterest/PinterestProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`PinterestExecArgs`](../interfaces/PinterestExecArgs.md)
...
`Partial`\<[`PinterestExecArgs`](../interfaces/PinterestExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`PinterestExecArgs`](../interfaces/PinterestExecArgs.md) & `object`
