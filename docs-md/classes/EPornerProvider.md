...
[downflux](../README.md) / EPornerProvider

# Class: EPornerProvider

Defined in: [packages/providers/eporner/EPornerProvider.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/eporner/EPornerProvider.ts#L14)
...
- [`BaseProvider`](BaseProvider.md)\<[`EPornerExecArgs`](../interfaces/EPornerExecArgs.md)\>

## Constructors

### Constructor

> **new EPornerProvider**(`url`): `EPornerProvider`

Defined in: [packages/providers/eporner/EPornerProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/eporner/EPornerProvider.ts#L17)
...
> `protected` `readonly` **provider**: [`EPorner`](../enumerations/Provider.md#eporner) = `Provider.EPorner`

Defined in: [packages/providers/eporner/EPornerProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/eporner/EPornerProvider.ts#L15)
...
> `protected` **buildRequest**(`overrides?`): [`EPornerExecArgs`](../interfaces/EPornerExecArgs.md)
...
`Partial`\<[`EPornerExecArgs`](../interfaces/EPornerExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`EPornerExecArgs`](../interfaces/EPornerExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`EPornerVideoOutput`](../interfaces/EPornerVideoOutput.md)\>

Defined in: [packages/providers/eporner/EPornerProvider.ts:39](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/eporner/EPornerProvider.ts#L39)

#### Returns

`Promise`\<[`EPornerVideoOutput`](../interfaces/EPornerVideoOutput.md)\>
