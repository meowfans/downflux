...
[downflux](../README.md) / BeegProvider

# Class: BeegProvider

Defined in: [packages/providers/beeg/BeegProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/beeg/BeegProvider.ts#L17)
...
- [`BaseProvider`](BaseProvider.md)\<[`BeegExecArgs`](../interfaces/BeegExecArgs.md)\>

## Constructors

### Constructor

> **new BeegProvider**(`url`): `BeegProvider`

Defined in: [packages/providers/beeg/BeegProvider.ts:21](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/beeg/BeegProvider.ts#L21)
...
> `protected` `readonly` **provider**: [`Beeg`](../enumerations/Provider.md#beeg) = `Provider.Beeg`

Defined in: [packages/providers/beeg/BeegProvider.ts:18](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/beeg/BeegProvider.ts#L18)
...
> `protected` **buildRequest**(`overrides?`): [`BeegExecArgs`](../interfaces/BeegExecArgs.md)
...
`Partial`\<[`BeegExecArgs`](../interfaces/BeegExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`BeegExecArgs`](../interfaces/BeegExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`BeegVideoOutput`](../interfaces/BeegVideoOutput.md)\>

Defined in: [packages/providers/beeg/BeegProvider.ts:62](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/beeg/BeegProvider.ts#L62)

#### Returns

`Promise`\<[`BeegVideoOutput`](../interfaces/BeegVideoOutput.md)\>
