...
[downflux](../README.md) / ImgurParser

# Class: ImgurParser

Defined in: [packages/providers/imgur/ImgurParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/imgur/ImgurParser.ts#L7)
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ImgurOutput`](../interfaces/ImgurOutput.md)\>\>\>

Defined in: [packages/providers/imgur/ImgurParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/imgur/ImgurParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ImgurOutput`](../interfaces/ImgurOutput.md)\>\>\>
