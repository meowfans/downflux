...
[downflux](../README.md) / XGroovyProvider

# Class: XGroovyProvider

Defined in: [packages/providers/xgroovy/XGroovyProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xgroovy/XGroovyProvider.ts#L16)
...
- [`BaseProvider`](BaseProvider.md)\<[`XGroovyExecArgs`](../interfaces/XGroovyExecArgs.md)\>

## Constructors

### Constructor

> **new XGroovyProvider**(`url`): `XGroovyProvider`

Defined in: [packages/providers/xgroovy/XGroovyProvider.ts:21](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xgroovy/XGroovyProvider.ts#L21)
...
> `protected` `readonly` **provider**: [`XGroovy`](../enumerations/Provider.md#xgroovy) = `Provider.XGroovy`

Defined in: [packages/providers/xgroovy/XGroovyProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xgroovy/XGroovyProvider.ts#L17)
...
> `protected` **buildRequest**(`overrides?`): [`XGroovyExecArgs`](../interfaces/XGroovyExecArgs.md)
...
`Partial`\<[`XGroovyExecArgs`](../interfaces/XGroovyExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`XGroovyExecArgs`](../interfaces/XGroovyExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`XGroovyVideoOutput`](../interfaces/XGroovyVideoOutput.md)\>

Defined in: [packages/providers/xgroovy/XGroovyProvider.ts:53](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xgroovy/XGroovyProvider.ts#L53)

#### Returns

`Promise`\<[`XGroovyVideoOutput`](../interfaces/XGroovyVideoOutput.md)\>

`XGroovyVideoOutput` with video metadata and source URLs.
