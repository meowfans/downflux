...
[downflux](../README.md) / ZzzTubeParser

# Class: ZzzTubeParser

Defined in: [packages/providers/zzztube/ZzzTubeParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/zzztube/ZzzTubeParser.ts#L13)
...
> **new ZzzTubeParser**(): `ZzzTubeParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ZzzTubeOutput`](../interfaces/ZzzTubeOutput.md)\>\>\>

Defined in: [packages/providers/zzztube/ZzzTubeParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/zzztube/ZzzTubeParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ZzzTubeOutput`](../interfaces/ZzzTubeOutput.md)\>\>\>
