...
[downflux](../README.md) / PornHubParser

# Class: PornHubParser

Defined in: [packages/providers/pornhub/PornHubParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornhub/PornHubParser.ts#L13)
...
> **new PornHubParser**(): `PornHubParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<`PornHubOutput`\>\>\>

Defined in: [packages/providers/pornhub/PornHubParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornhub/PornHubParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<`PornHubOutput`\>\>\>
