...
[downflux](../README.md) / XCafeTransformer
...
- [`BaseTransformer`](BaseTransformer.md)\<[`XCafeExecArgs`](../interfaces/XCafeExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`XCafeVideoOutput`](../interfaces/XCafeVideoOutput.md)\>
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`XCafeVideoOutput`](../interfaces/XCafeVideoOutput.md)\>
