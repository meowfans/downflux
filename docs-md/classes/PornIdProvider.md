...
[downflux](../README.md) / PornIdProvider

# Class: PornIdProvider

Defined in: [packages/providers/pornid/PornIdProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornid/PornIdProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`PornIdExecArgs`](../interfaces/PornIdExecArgs.md)\>

## Constructors

### Constructor

> **new PornIdProvider**(`url`): `PornIdProvider`

Defined in: [packages/providers/pornid/PornIdProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornid/PornIdProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`PornId`](../enumerations/Provider.md#pornid) = `Provider.PornId`

Defined in: [packages/providers/pornid/PornIdProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornid/PornIdProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`PornIdExecArgs`](../interfaces/PornIdExecArgs.md)
...
`Partial`\<[`PornIdExecArgs`](../interfaces/PornIdExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`PornIdExecArgs`](../interfaces/PornIdExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`PornIdVideoOutput`](../interfaces/PornIdVideoOutput.md)\>

Defined in: [packages/providers/pornid/PornIdProvider.ts:46](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornid/PornIdProvider.ts#L46)

#### Returns

`Promise`\<[`PornIdVideoOutput`](../interfaces/PornIdVideoOutput.md)\>
