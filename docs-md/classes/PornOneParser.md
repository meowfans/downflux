...
[downflux](../README.md) / PornOneParser

# Class: PornOneParser

Defined in: [packages/providers/pornone/PornOneParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornone/PornOneParser.ts#L13)
...
> **new PornOneParser**(): `PornOneParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PornOneOutput`](../interfaces/PornOneOutput.md)\>\>\>

Defined in: [packages/providers/pornone/PornOneParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornone/PornOneParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PornOneOutput`](../interfaces/PornOneOutput.md)\>\>\>
