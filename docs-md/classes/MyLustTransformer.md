...
[downflux](../README.md) / MyLustTransformer

# Class: MyLustTransformer

Defined in: [packages/providers/mylust/MyLustTransformer.ts:12](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustTransformer.ts#L12)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`MyLustExecArgs`](../interfaces/MyLustExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`MyLustVideoOutput`](../interfaces/MyLustVideoOutput.md)\>

## Constructors

### Constructor

> **new MyLustTransformer**(`httpClient`, `progressManager`): `MyLustTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`MyLustVideoOutput`](../interfaces/MyLustVideoOutput.md)\>

Defined in: [packages/providers/mylust/MyLustTransformer.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustTransformer.ts#L13)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`MyLustVideoOutput`](../interfaces/MyLustVideoOutput.md)\>
