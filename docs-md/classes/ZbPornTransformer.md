...
[downflux](../README.md) / ZbPornTransformer

# Class: ZbPornTransformer

Defined in: [packages/providers/zbporn/ZbPornTransformer.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/zbporn/ZbPornTransformer.ts#L14)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`ZbPornExecArgs`](../interfaces/ZbPornExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`ZbPornVideoOutput`](../interfaces/ZbPornVideoOutput.md)\>

## Constructors

### Constructor

> **new ZbPornTransformer**(`httpClient`, `progressManager`): `ZbPornTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`ZbPornVideoOutput`](../interfaces/ZbPornVideoOutput.md)\>

Defined in: [packages/providers/zbporn/ZbPornTransformer.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/zbporn/ZbPornTransformer.ts#L15)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`ZbPornVideoOutput`](../interfaces/ZbPornVideoOutput.md)\>
