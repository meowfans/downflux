...
[downflux](../README.md) / BlackPornTransformer

# Class: BlackPornTransformer

Defined in: [packages/providers/blackporn/BlackPornTransformer.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/blackporn/BlackPornTransformer.ts#L16)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`BlackPornExecArgs`](../interfaces/BlackPornExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new BlackPornTransformer**(`httpClient`, `progressManager`): `BlackPornTransformer`
...
Defined in: [packages/providers/blackporn/BlackPornTransformer.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/blackporn/BlackPornTransformer.ts#L17)
