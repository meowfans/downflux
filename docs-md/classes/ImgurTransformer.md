...
[downflux](../README.md) / ImgurTransformer

# Class: ImgurTransformer

Defined in: [packages/providers/imgur/ImgurTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/imgur/ImgurTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`ImgurExecArgs`](../interfaces/ImgurExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new ImgurTransformer**(`httpClient`, `progressManager`): `ImgurTransformer`
...
Defined in: [packages/providers/imgur/ImgurTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/imgur/ImgurTransformer.ts#L9)
