...
[downflux](../README.md) / UnsplashProvider

# Class: UnsplashProvider

Defined in: [packages/providers/unsplash/UnsplashProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/unsplash/UnsplashProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`UnsplashExecArgs`](../interfaces/UnsplashExecArgs.md)\>

## Constructors

### Constructor

> **new UnsplashProvider**(`url`): `UnsplashProvider`

Defined in: [packages/providers/unsplash/UnsplashProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/unsplash/UnsplashProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`UnsplashExecArgs`](../interfaces/UnsplashExecArgs.md)
...
`Partial`\<[`UnsplashExecArgs`](../interfaces/UnsplashExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`UnsplashExecArgs`](../interfaces/UnsplashExecArgs.md) & `object`
