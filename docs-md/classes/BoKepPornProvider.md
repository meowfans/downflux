...
[downflux](../README.md) / BoKepPornProvider

# Class: BoKepPornProvider

Defined in: [packages/providers/bokepporn/BoKepPornProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bokepporn/BoKepPornProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`BoKepPornExecArgs`](../interfaces/BoKepPornExecArgs.md)\>

## Constructors

### Constructor

> **new BoKepPornProvider**(`url`): `BoKepPornProvider`

Defined in: [packages/providers/bokepporn/BoKepPornProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bokepporn/BoKepPornProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`BoKepPorn`](../enumerations/Provider.md#bokepporn) = `Provider.BoKepPorn`

Defined in: [packages/providers/bokepporn/BoKepPornProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bokepporn/BoKepPornProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`BoKepPornExecArgs`](../interfaces/BoKepPornExecArgs.md)
...
`Partial`\<[`BoKepPornExecArgs`](../interfaces/BoKepPornExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`BoKepPornExecArgs`](../interfaces/BoKepPornExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`BoKepPornVideoOutput`](../interfaces/BoKepPornVideoOutput.md)\>

Defined in: [packages/providers/bokepporn/BoKepPornProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/bokepporn/BoKepPornProvider.ts#L45)

#### Returns

`Promise`\<[`BoKepPornVideoOutput`](../interfaces/BoKepPornVideoOutput.md)\>
