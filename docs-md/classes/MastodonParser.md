...
[downflux](../README.md) / MastodonParser

# Class: MastodonParser

Defined in: [packages/providers/mastodon/MastodonParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mastodon/MastodonParser.ts#L7)
...
> **new MastodonParser**(): `MastodonParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`MastodonOutput`](../interfaces/MastodonOutput.md)\>\>\>

Defined in: [packages/providers/mastodon/MastodonParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mastodon/MastodonParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`MastodonOutput`](../interfaces/MastodonOutput.md)\>\>\>
