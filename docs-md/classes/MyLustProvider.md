...
[downflux](../README.md) / MyLustProvider

# Class: MyLustProvider

Defined in: [packages/providers/mylust/MyLustProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`MyLustExecArgs`](../interfaces/MyLustExecArgs.md)\>

## Constructors

### Constructor

> **new MyLustProvider**(`url`): `MyLustProvider`

Defined in: [packages/providers/mylust/MyLustProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`MyLust`](../enumerations/Provider.md#mylust) = `Provider.MyLust`

Defined in: [packages/providers/mylust/MyLustProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`MyLustExecArgs`](../interfaces/MyLustExecArgs.md)
...
`Partial`\<[`MyLustExecArgs`](../interfaces/MyLustExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`MyLustExecArgs`](../interfaces/MyLustExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`MyLustVideoOutput`](../interfaces/MyLustVideoOutput.md)\>

Defined in: [packages/providers/mylust/MyLustProvider.ts:46](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustProvider.ts#L46)

#### Returns

`Promise`\<[`MyLustVideoOutput`](../interfaces/MyLustVideoOutput.md)\>
