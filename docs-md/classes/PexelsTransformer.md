...
[downflux](../README.md) / PexelsTransformer

# Class: PexelsTransformer

Defined in: [packages/providers/pexels/PexelsTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pexels/PexelsTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`PexelsExecArgs`](../interfaces/PexelsExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new PexelsTransformer**(`httpClient`, `progressManager`): `PexelsTransformer`
...
Defined in: [packages/providers/pexels/PexelsTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pexels/PexelsTransformer.ts#L9)
