...
[downflux](../README.md) / MomVidsParser

# Class: MomVidsParser

Defined in: [packages/providers/momvids/MomVidsParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/momvids/MomVidsParser.ts#L13)
...
> **new MomVidsParser**(): `MomVidsParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`MomVidsOutput`](../interfaces/MomVidsOutput.md)\>\>\>

Defined in: [packages/providers/momvids/MomVidsParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/momvids/MomVidsParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`MomVidsOutput`](../interfaces/MomVidsOutput.md)\>\>\>
