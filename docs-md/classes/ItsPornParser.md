...
[downflux](../README.md) / ItsPornParser

# Class: ItsPornParser

Defined in: [packages/providers/itsporn/ItsPornParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/itsporn/ItsPornParser.ts#L13)
...
> **new ItsPornParser**(): `ItsPornParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ItsPornOutput`](../interfaces/ItsPornOutput.md)\>\>\>

Defined in: [packages/providers/itsporn/ItsPornParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/itsporn/ItsPornParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ItsPornOutput`](../interfaces/ItsPornOutput.md)\>\>\>
