...
[downflux](../README.md) / NewgroundsParser

# Class: NewgroundsParser

Defined in: [packages/providers/newgrounds/NewgroundsParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/newgrounds/NewgroundsParser.ts#L7)
...
> **new NewgroundsParser**(): `NewgroundsParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`NewgroundsOutput`](../interfaces/NewgroundsOutput.md)\>\>\>

Defined in: [packages/providers/newgrounds/NewgroundsParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/newgrounds/NewgroundsParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`NewgroundsOutput`](../interfaces/NewgroundsOutput.md)\>\>\>
