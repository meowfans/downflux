...
[downflux](../README.md) / WikimediaParser

# Class: WikimediaParser

Defined in: [packages/providers/wikimedia/WikimediaParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikimedia/WikimediaParser.ts#L7)
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`WikimediaOutput`](../interfaces/WikimediaOutput.md)\>\>\>

Defined in: [packages/providers/wikimedia/WikimediaParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikimedia/WikimediaParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`WikimediaOutput`](../interfaces/WikimediaOutput.md)\>\>\>
