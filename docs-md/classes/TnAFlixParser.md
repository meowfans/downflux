...
[downflux](../README.md) / TnAFlixParser

# Class: TnAFlixParser

Defined in: [packages/providers/tnaflix/TnAFlixParser.ts:12](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/tnaflix/TnAFlixParser.ts#L12)
...
> **new TnAFlixParser**(): `TnAFlixParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`TnAFlixOutput`](../interfaces/TnAFlixOutput.md)\>\>\>

Defined in: [packages/providers/tnaflix/TnAFlixParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/tnaflix/TnAFlixParser.ts#L13)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`TnAFlixOutput`](../interfaces/TnAFlixOutput.md)\>\>\>
