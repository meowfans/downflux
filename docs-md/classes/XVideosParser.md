...
[downflux](../README.md) / XVideosParser

# Class: XVideosParser

Defined in: [packages/providers/xvideos/XVideosParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xvideos/XVideosParser.ts#L13)
...
> **new XVideosParser**(): `XVideosParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`XVideosOutput`](../interfaces/XVideosOutput.md)\>\>\>

Defined in: [packages/providers/xvideos/XVideosParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xvideos/XVideosParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`XVideosOutput`](../interfaces/XVideosOutput.md)\>\>\>
