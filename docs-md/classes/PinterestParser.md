...
[downflux](../README.md) / PinterestParser

# Class: PinterestParser

Defined in: [packages/providers/pinterest/PinterestParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pinterest/PinterestParser.ts#L7)
...
> **new PinterestParser**(): `PinterestParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PinterestOutput`](../interfaces/PinterestOutput.md)\>\>\>

Defined in: [packages/providers/pinterest/PinterestParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pinterest/PinterestParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PinterestOutput`](../interfaces/PinterestOutput.md)\>\>\>
