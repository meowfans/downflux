...
[downflux](../README.md) / PornsOkProvider

# Class: PornsOkProvider

Defined in: [packages/providers/pornsok/PornsOkProvider.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornsok/PornsOkProvider.ts#L13)
...
- [`BaseProvider`](BaseProvider.md)\<[`PornsOkExecArgs`](../interfaces/PornsOkExecArgs.md)\>

## Constructors

### Constructor

> **new PornsOkProvider**(`url`): `PornsOkProvider`

Defined in: [packages/providers/pornsok/PornsOkProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornsok/PornsOkProvider.ts#L16)
...
> `protected` `readonly` **provider**: [`PornsOk`](../enumerations/Provider.md#pornsok) = `Provider.PornsOk`

Defined in: [packages/providers/pornsok/PornsOkProvider.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornsok/PornsOkProvider.ts#L14)
...
> `protected` **buildRequest**(`overrides?`): [`PornsOkExecArgs`](../interfaces/PornsOkExecArgs.md)
...
`Partial`\<[`PornsOkExecArgs`](../interfaces/PornsOkExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`PornsOkExecArgs`](../interfaces/PornsOkExecArgs.md) & `object`
...
> **getVideo**(`quality?`): `Promise`\<[`PornsOkVideoOutput`](../interfaces/PornsOkVideoOutput.md)\>

Defined in: [packages/providers/pornsok/PornsOkProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pornsok/PornsOkProvider.ts#L45)
...
`Promise`\<[`PornsOkVideoOutput`](../interfaces/PornsOkVideoOutput.md)\>

`PornsOkVideoOutput` containing video metadata and source URLs.
