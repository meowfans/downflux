...
[downflux](../README.md) / ProgressManager
...
> **new ProgressManager**(`options?`): `ProgressManager`
...
[`ProgressEvents`](../interfaces/ProgressEvents.md)\[`E`\]
...
...`Parameters`\<[`ProgressEvents`](../interfaces/ProgressEvents.md)\[`E`\]\>
...
`Partial`\<[`JobProgressEvent`](../interfaces/JobProgressEvent.md)\>
