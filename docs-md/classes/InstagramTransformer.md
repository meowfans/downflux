...
[downflux](../README.md) / InstagramTransformer

# Class: InstagramTransformer

Defined in: [packages/providers/instagram/InstagramTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/instagram/InstagramTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`InstagramExecArgs`](../interfaces/InstagramExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new InstagramTransformer**(`httpClient`, `progressManager`): `InstagramTransformer`
...
Defined in: [packages/providers/instagram/InstagramTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/instagram/InstagramTransformer.ts#L9)
