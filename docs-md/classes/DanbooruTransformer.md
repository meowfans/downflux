...
[downflux](../README.md) / DanbooruTransformer

# Class: DanbooruTransformer

Defined in: [packages/providers/danbooru/DanbooruTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danbooru/DanbooruTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`DanbooruExecArgs`](../interfaces/DanbooruExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new DanbooruTransformer**(`httpClient`, `progressManager`): `DanbooruTransformer`
...
Defined in: [packages/providers/danbooru/DanbooruTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/danbooru/DanbooruTransformer.ts#L9)
