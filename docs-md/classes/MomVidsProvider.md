...
[downflux](../README.md) / MomVidsProvider

# Class: MomVidsProvider

Defined in: [packages/providers/momvids/MomVidsProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/momvids/MomVidsProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`MomVidsExecArgs`](../interfaces/MomVidsExecArgs.md)\>

## Constructors

### Constructor

> **new MomVidsProvider**(`url`): `MomVidsProvider`

Defined in: [packages/providers/momvids/MomVidsProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/momvids/MomVidsProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`MomVids`](../enumerations/Provider.md#momvids) = `Provider.MomVids`

Defined in: [packages/providers/momvids/MomVidsProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/momvids/MomVidsProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`MomVidsExecArgs`](../interfaces/MomVidsExecArgs.md)
...
`Partial`\<[`MomVidsExecArgs`](../interfaces/MomVidsExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`MomVidsExecArgs`](../interfaces/MomVidsExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`MomVidsVideoOutput`](../interfaces/MomVidsVideoOutput.md)\>

Defined in: [packages/providers/momvids/MomVidsProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/momvids/MomVidsProvider.ts#L45)

#### Returns

`Promise`\<[`MomVidsVideoOutput`](../interfaces/MomVidsVideoOutput.md)\>
