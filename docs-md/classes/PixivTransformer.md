...
[downflux](../README.md) / PixivTransformer

# Class: PixivTransformer

Defined in: [packages/providers/pixiv/PixivTransformer.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pixiv/PixivTransformer.ts#L8)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`PixivExecArgs`](../interfaces/PixivExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\>

## Constructors

### Constructor

> **new PixivTransformer**(`httpClient`, `progressManager`): `PixivTransformer`
...
Defined in: [packages/providers/pixiv/PixivTransformer.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pixiv/PixivTransformer.ts#L9)
