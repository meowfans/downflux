...
[downflux](../README.md) / DeviantArtProvider

# Class: DeviantArtProvider

Defined in: [packages/providers/deviantart/DeviantArtProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/deviantart/DeviantArtProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`DeviantArtExecArgs`](../interfaces/DeviantArtExecArgs.md)\>

## Constructors

### Constructor

> **new DeviantArtProvider**(`url`): `DeviantArtProvider`

Defined in: [packages/providers/deviantart/DeviantArtProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/deviantart/DeviantArtProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`DeviantArtExecArgs`](../interfaces/DeviantArtExecArgs.md)
...
`Partial`\<[`DeviantArtExecArgs`](../interfaces/DeviantArtExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`DeviantArtExecArgs`](../interfaces/DeviantArtExecArgs.md) & `object`
