...
[downflux](../README.md) / MomVidsTransformer

# Class: MomVidsTransformer

Defined in: [packages/providers/momvids/MomVidsTransformer.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/momvids/MomVidsTransformer.ts#L14)
...
- [`BaseTransformer`](BaseTransformer.md)\<[`MomVidsExecArgs`](../interfaces/MomVidsExecArgs.md), [`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md) \| [`MomVidsVideoOutput`](../interfaces/MomVidsVideoOutput.md)\>

## Constructors

### Constructor

> **new MomVidsTransformer**(`httpClient`, `progressManager`): `MomVidsTransformer`
...
> **transform**(`url`, `request?`): `Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`MomVidsVideoOutput`](../interfaces/MomVidsVideoOutput.md)\>

Defined in: [packages/providers/momvids/MomVidsTransformer.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/momvids/MomVidsTransformer.ts#L15)
...
`Promise`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`unknown`\> \| [`MomVidsVideoOutput`](../interfaces/MomVidsVideoOutput.md)\>
