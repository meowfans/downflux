...
[downflux](../README.md) / PixivParser

# Class: PixivParser

Defined in: [packages/providers/pixiv/PixivParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pixiv/PixivParser.ts#L7)
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PixivOutput`](../interfaces/PixivOutput.md)\>\>\>

Defined in: [packages/providers/pixiv/PixivParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/pixiv/PixivParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`PixivOutput`](../interfaces/PixivOutput.md)\>\>\>
