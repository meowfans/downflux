...
[downflux](../README.md) / ColliderPornParser

# Class: ColliderPornParser

Defined in: [packages/providers/colliderporn/ColliderPornParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/colliderporn/ColliderPornParser.ts#L13)
...
> **new ColliderPornParser**(): `ColliderPornParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ColliderPornOutput`](../interfaces/ColliderPornOutput.md)\>\>\>

Defined in: [packages/providers/colliderporn/ColliderPornParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/colliderporn/ColliderPornParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ColliderPornOutput`](../interfaces/ColliderPornOutput.md)\>\>\>
