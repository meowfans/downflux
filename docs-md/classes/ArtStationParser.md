...
[downflux](../README.md) / ArtStationParser

# Class: ArtStationParser

Defined in: [packages/providers/artstation/ArtStationParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/artstation/ArtStationParser.ts#L7)
...
> **new ArtStationParser**(): `ArtStationParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ArtStationOutput`](../interfaces/ArtStationOutput.md)\>\>\>

Defined in: [packages/providers/artstation/ArtStationParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/artstation/ArtStationParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`ArtStationOutput`](../interfaces/ArtStationOutput.md)\>\>\>
