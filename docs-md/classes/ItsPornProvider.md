...
[downflux](../README.md) / ItsPornProvider

# Class: ItsPornProvider

Defined in: [packages/providers/itsporn/ItsPornProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/itsporn/ItsPornProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`ItsPornExecArgs`](../interfaces/ItsPornExecArgs.md)\>

## Constructors

### Constructor

> **new ItsPornProvider**(`url`): `ItsPornProvider`

Defined in: [packages/providers/itsporn/ItsPornProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/itsporn/ItsPornProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`ItsPorn`](../enumerations/Provider.md#itsporn) = `Provider.ItsPorn`

Defined in: [packages/providers/itsporn/ItsPornProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/itsporn/ItsPornProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`ItsPornExecArgs`](../interfaces/ItsPornExecArgs.md)
...
`Partial`\<[`ItsPornExecArgs`](../interfaces/ItsPornExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`ItsPornExecArgs`](../interfaces/ItsPornExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`ItsPornVideoOutput`](../interfaces/ItsPornVideoOutput.md)\>

Defined in: [packages/providers/itsporn/ItsPornProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/itsporn/ItsPornProvider.ts#L45)

#### Returns

`Promise`\<[`ItsPornVideoOutput`](../interfaces/ItsPornVideoOutput.md)\>
