...
[downflux](../README.md) / SxyPornProvider

# Class: SxyPornProvider

Defined in: [packages/providers/sxyporn/SxyPornProvider.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sxyporn/SxyPornProvider.ts#L17)
...
- [`BaseProvider`](BaseProvider.md)\<[`SxyPornExecArgs`](../interfaces/SxyPornExecArgs.md)\>

## Constructors

### Constructor

> **new SxyPornProvider**(`url`): `SxyPornProvider`

Defined in: [packages/providers/sxyporn/SxyPornProvider.ts:21](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sxyporn/SxyPornProvider.ts#L21)
...
> `protected` `readonly` **provider**: [`SxyPorn`](../enumerations/Provider.md#sxyporn) = `Provider.SxyPorn`

Defined in: [packages/providers/sxyporn/SxyPornProvider.ts:18](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sxyporn/SxyPornProvider.ts#L18)
...
> `protected` **buildRequest**(`overrides?`): [`SxyPornExecArgs`](../interfaces/SxyPornExecArgs.md)
...
`Partial`\<[`SxyPornExecArgs`](../interfaces/SxyPornExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`SxyPornExecArgs`](../interfaces/SxyPornExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`SxyPornVideoOutput`](../interfaces/SxyPornVideoOutput.md)\>

Defined in: [packages/providers/sxyporn/SxyPornProvider.ts:54](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sxyporn/SxyPornProvider.ts#L54)

#### Returns

`Promise`\<[`SxyPornVideoOutput`](../interfaces/SxyPornVideoOutput.md)\>

`SxyPornVideoOutput` with video metadata and source URLs.
