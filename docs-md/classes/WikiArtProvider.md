...
[downflux](../README.md) / WikiArtProvider

# Class: WikiArtProvider

Defined in: [packages/providers/wikiart/WikiArtProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikiart/WikiArtProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`WikiArtExecArgs`](../interfaces/WikiArtExecArgs.md)\>

## Constructors

### Constructor

> **new WikiArtProvider**(`url`): `WikiArtProvider`

Defined in: [packages/providers/wikiart/WikiArtProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikiart/WikiArtProvider.ts#L6)
...
[`GenericContentProvider`](GenericContentProvider.md).[`executionOptions`](GenericContentProvider.md#executionoptions)
...
> `protected` **buildRequest**(`overrides?`): [`WikiArtExecArgs`](../interfaces/WikiArtExecArgs.md)
...
`Partial`\<[`WikiArtExecArgs`](../interfaces/WikiArtExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`WikiArtExecArgs`](../interfaces/WikiArtExecArgs.md) & `object`
