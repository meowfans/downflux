...
[downflux](../README.md) / TwitterParser

# Class: TwitterParser

Defined in: [packages/providers/twitter/TwitterParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterParser.ts#L7)
...
> **new TwitterParser**(): `TwitterParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`TwitterOutput`](../interfaces/TwitterOutput.md)\>\>\>

Defined in: [packages/providers/twitter/TwitterParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/twitter/TwitterParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`TwitterOutput`](../interfaces/TwitterOutput.md)\>\>\>
