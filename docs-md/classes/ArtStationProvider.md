...
[downflux](../README.md) / ArtStationProvider

# Class: ArtStationProvider

Defined in: [packages/providers/artstation/ArtStationProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/artstation/ArtStationProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`ArtStationExecArgs`](../interfaces/ArtStationExecArgs.md)\>

## Constructors

### Constructor

> **new ArtStationProvider**(`url`): `ArtStationProvider`

Defined in: [packages/providers/artstation/ArtStationProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/artstation/ArtStationProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`ArtStationExecArgs`](../interfaces/ArtStationExecArgs.md)
...
`Partial`\<[`ArtStationExecArgs`](../interfaces/ArtStationExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`ArtStationExecArgs`](../interfaces/ArtStationExecArgs.md) & `object`
