...
[downflux](../README.md) / UnsplashParser

# Class: UnsplashParser

Defined in: [packages/providers/unsplash/UnsplashParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/unsplash/UnsplashParser.ts#L7)
...
> **new UnsplashParser**(): `UnsplashParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`UnsplashOutput`](../interfaces/UnsplashOutput.md)\>\>\>

Defined in: [packages/providers/unsplash/UnsplashParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/unsplash/UnsplashParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`UnsplashOutput`](../interfaces/UnsplashOutput.md)\>\>\>
