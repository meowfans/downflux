...
[downflux](../README.md) / ImgurProvider
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`ImgurExecArgs`](../interfaces/ImgurExecArgs.md)\>
...
`Partial`\<[`ImgurExecArgs`](../interfaces/ImgurExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`ImgurExecArgs`](../interfaces/ImgurExecArgs.md) & `object`
