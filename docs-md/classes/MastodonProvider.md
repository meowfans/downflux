...
[downflux](../README.md) / MastodonProvider

# Class: MastodonProvider

Defined in: [packages/providers/mastodon/MastodonProvider.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mastodon/MastodonProvider.ts#L5)
...
- [`GenericContentProvider`](GenericContentProvider.md)\<[`MastodonExecArgs`](../interfaces/MastodonExecArgs.md)\>

## Constructors

### Constructor

> **new MastodonProvider**(`url`): `MastodonProvider`

Defined in: [packages/providers/mastodon/MastodonProvider.ts:6](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mastodon/MastodonProvider.ts#L6)
...
> `protected` **buildRequest**(`overrides?`): [`MastodonExecArgs`](../interfaces/MastodonExecArgs.md)
...
`Partial`\<[`MastodonExecArgs`](../interfaces/MastodonExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`MastodonExecArgs`](../interfaces/MastodonExecArgs.md) & `object`
