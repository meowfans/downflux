...
[downflux](../README.md) / SuperPornParser

# Class: SuperPornParser

Defined in: [packages/providers/superporn/SuperPornParser.ts:13](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/superporn/SuperPornParser.ts#L13)
...
> **new SuperPornParser**(): `SuperPornParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`SuperPornOutput`](../interfaces/SuperPornOutput.md)\>\>\>

Defined in: [packages/providers/superporn/SuperPornParser.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/superporn/SuperPornParser.ts#L14)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`SuperPornOutput`](../interfaces/SuperPornOutput.md)\>\>\>
