...
[downflux](../README.md) / WikimediaPipeline

# Class: WikimediaPipeline

Defined in: [packages/providers/wikimedia/WikimediaPipeline.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikimedia/WikimediaPipeline.ts#L7)
...
- [`BasePipeline`](BasePipeline.md)\<[`WikimediaExecArgs`](../interfaces/WikimediaExecArgs.md), [`WikimediaOutput`](../interfaces/WikimediaOutput.md)\>

## Constructors

### Constructor

> **new WikimediaPipeline**(`fileManager`): `WikimediaPipeline`
...
Defined in: [packages/providers/wikimedia/WikimediaPipeline.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wikimedia/WikimediaPipeline.ts#L8)
...
[`IdentifierContext`](../interfaces/IdentifierContext.md)\<[`WikimediaOutput`](../interfaces/WikimediaOutput.md)\>
