...
[downflux](../README.md) / BehanceParser

# Class: BehanceParser

Defined in: [packages/providers/behance/BehanceParser.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/behance/BehanceParser.ts#L7)
...
> **new BehanceParser**(): `BehanceParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`BehanceOutput`](../interfaces/BehanceOutput.md)\>\>\>

Defined in: [packages/providers/behance/BehanceParser.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/behance/BehanceParser.ts#L8)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<[`BehanceOutput`](../interfaces/BehanceOutput.md)\>\>\>
