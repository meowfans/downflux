...
[downflux](../README.md) / TubeVSexProvider

# Class: TubeVSexProvider

Defined in: [packages/providers/tubevsex/TubeVSexProvider.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/tubevsex/TubeVSexProvider.ts#L15)
...
- [`BaseProvider`](BaseProvider.md)\<[`TubeVSexExecArgs`](../interfaces/TubeVSexExecArgs.md)\>

## Constructors

### Constructor

> **new TubeVSexProvider**(`url`): `TubeVSexProvider`

Defined in: [packages/providers/tubevsex/TubeVSexProvider.ts:19](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/tubevsex/TubeVSexProvider.ts#L19)
...
> `protected` `readonly` **provider**: [`TubeVSex`](../enumerations/Provider.md#tubevsex) = `Provider.TubeVSex`

Defined in: [packages/providers/tubevsex/TubeVSexProvider.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/tubevsex/TubeVSexProvider.ts#L16)
...
> `protected` **buildRequest**(`overrides?`): [`TubeVSexExecArgs`](../interfaces/TubeVSexExecArgs.md)
...
`Partial`\<[`TubeVSexExecArgs`](../interfaces/TubeVSexExecArgs.md)\>
...
\{ `entryUrl?`: `string`; \} \| [`TubeVSexExecArgs`](../interfaces/TubeVSexExecArgs.md) & `object`
...
> **getVideo**(): `Promise`\<[`TubeVSexVideoOutput`](../interfaces/TubeVSexVideoOutput.md)\>

Defined in: [packages/providers/tubevsex/TubeVSexProvider.ts:45](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/tubevsex/TubeVSexProvider.ts#L45)

#### Returns

`Promise`\<[`TubeVSexVideoOutput`](../interfaces/TubeVSexVideoOutput.md)\>
