...
[downflux](../README.md) / WallHavenParser

# Class: WallHavenParser

Defined in: [packages/providers/wallhaven/WallHavenParser.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wallhaven/WallHavenParser.ts#L15)
...
> **new WallHavenParser**(): `WallHavenParser`
...
> **transform**(`html`, `sourceUrl`): `Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<`WallHavenOutput`\>\>\>

Defined in: [packages/providers/wallhaven/WallHavenParser.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/wallhaven/WallHavenParser.ts#L16)
...
`Partial`\<[`DefaultExecutionResult`](../interfaces/DefaultExecutionResult.md)\<`Partial`\<`WallHavenOutput`\>\>\>
