...
[downflux](../README.md) / XozillaOutput

# Interface: XozillaOutput

Defined in: [packages/providers/xozilla/XozillaContracts.ts:4](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xozilla/XozillaContracts.ts#L4)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`XozillaVideoOutput`](XozillaVideoOutput.md)
...
[`XozillaVideoOutput`](XozillaVideoOutput.md).[`tags`](XozillaVideoOutput.md#tags)
...
[`XozillaVideoOutput`](XozillaVideoOutput.md).[`pageUrl`](XozillaVideoOutput.md#pageurl)
...
[`XozillaVideoOutput`](XozillaVideoOutput.md).[`poster`](XozillaVideoOutput.md#poster)
...
[`XozillaVideoOutput`](XozillaVideoOutput.md).[`videos`](XozillaVideoOutput.md#videos)
...
[`XozillaVideoOutput`](XozillaVideoOutput.md).[`videoId`](XozillaVideoOutput.md#videoid)
...
[`XozillaVideoOutput`](XozillaVideoOutput.md).[`previews`](XozillaVideoOutput.md#previews)
...
[`XozillaVideoOutput`](XozillaVideoOutput.md).[`timelineScreenCount`](XozillaVideoOutput.md#timelinescreencount)
...
[`XozillaVideoOutput`](XozillaVideoOutput.md).[`timelineScreens`](XozillaVideoOutput.md#timelinescreens)
...
[`XozillaVideoOutput`](XozillaVideoOutput.md).[`starred`](XozillaVideoOutput.md#starred)
...
[`XozillaVideoOutput`](XozillaVideoOutput.md).[`uploader`](XozillaVideoOutput.md#uploader)
