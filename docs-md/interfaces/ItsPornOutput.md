...
[downflux](../README.md) / ItsPornOutput

# Interface: ItsPornOutput

Defined in: [packages/providers/itsporn/ItsPornContracts.ts:4](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/itsporn/ItsPornContracts.ts#L4)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`ItsPornVideoOutput`](ItsPornVideoOutput.md)
...
[`ItsPornVideoOutput`](ItsPornVideoOutput.md).[`tags`](ItsPornVideoOutput.md#tags)
...
[`ItsPornVideoOutput`](ItsPornVideoOutput.md).[`pageUrl`](ItsPornVideoOutput.md#pageurl)
...
[`ItsPornVideoOutput`](ItsPornVideoOutput.md).[`poster`](ItsPornVideoOutput.md#poster)
...
[`ItsPornVideoOutput`](ItsPornVideoOutput.md).[`videos`](ItsPornVideoOutput.md#videos)
...
[`ItsPornVideoOutput`](ItsPornVideoOutput.md).[`videoId`](ItsPornVideoOutput.md#videoid)
...
[`ItsPornVideoOutput`](ItsPornVideoOutput.md).[`previews`](ItsPornVideoOutput.md#previews)
...
[`ItsPornVideoOutput`](ItsPornVideoOutput.md).[`timelineScreenCount`](ItsPornVideoOutput.md#timelinescreencount)
...
[`ItsPornVideoOutput`](ItsPornVideoOutput.md).[`timelineScreens`](ItsPornVideoOutput.md#timelinescreens)
...
[`ItsPornVideoOutput`](ItsPornVideoOutput.md).[`starred`](ItsPornVideoOutput.md#starred)
...
[`ItsPornVideoOutput`](ItsPornVideoOutput.md).[`uploader`](ItsPornVideoOutput.md#uploader)
