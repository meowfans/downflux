...
[downflux](../README.md) / XCafeOutput

# Interface: XCafeOutput

Defined in: [packages/providers/xcafe/XCafeContracts.ts:4](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xcafe/XCafeContracts.ts#L4)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`XCafeVideoOutput`](XCafeVideoOutput.md)
...
[`XCafeVideoOutput`](XCafeVideoOutput.md).[`tags`](XCafeVideoOutput.md#tags)
...
[`XCafeVideoOutput`](XCafeVideoOutput.md).[`pageUrl`](XCafeVideoOutput.md#pageurl)
...
[`XCafeVideoOutput`](XCafeVideoOutput.md).[`poster`](XCafeVideoOutput.md#poster)
...
[`XCafeVideoOutput`](XCafeVideoOutput.md).[`videos`](XCafeVideoOutput.md#videos)
...
Defined in: [packages/providers/xcafe/XCafeContracts.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xcafe/XCafeContracts.ts#L7)

#### Inherited from

[`XCafeVideoOutput`](XCafeVideoOutput.md).[`uploader`](XCafeVideoOutput.md#uploader)
