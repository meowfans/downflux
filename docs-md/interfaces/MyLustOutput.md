...
[downflux](../README.md) / MyLustOutput

# Interface: MyLustOutput

Defined in: [packages/providers/mylust/MyLustContracts.ts:4](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustContracts.ts#L4)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`MyLustVideoOutput`](MyLustVideoOutput.md)
...
[`MyLustVideoOutput`](MyLustVideoOutput.md).[`tags`](MyLustVideoOutput.md#tags)
...
[`MyLustVideoOutput`](MyLustVideoOutput.md).[`pageUrl`](MyLustVideoOutput.md#pageurl)
...
[`MyLustVideoOutput`](MyLustVideoOutput.md).[`poster`](MyLustVideoOutput.md#poster)
...
[`MyLustVideoOutput`](MyLustVideoOutput.md).[`videos`](MyLustVideoOutput.md#videos)
...
Defined in: [packages/providers/mylust/MyLustContracts.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustContracts.ts#L7)

#### Inherited from

[`MyLustVideoOutput`](MyLustVideoOutput.md).[`uploader`](MyLustVideoOutput.md#uploader)
...
Defined in: [packages/providers/mylust/MyLustContracts.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustContracts.ts#L8)

#### Inherited from

[`MyLustVideoOutput`](MyLustVideoOutput.md).[`videoId`](MyLustVideoOutput.md#videoid)
...
Defined in: [packages/providers/mylust/MyLustContracts.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/mylust/MyLustContracts.ts#L9)

#### Inherited from

[`MyLustVideoOutput`](MyLustVideoOutput.md).[`actors`](MyLustVideoOutput.md#actors)
