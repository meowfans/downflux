...
[downflux](../README.md) / PornDoeOutput

# Interface: PornDoeOutput

Defined in: [packages/providers/porndoe/PornDoeContracts.ts:4](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeContracts.ts#L4)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`PornDoeVideoOutput`](PornDoeVideoOutput.md)
...
[`PornDoeVideoOutput`](PornDoeVideoOutput.md).[`tags`](PornDoeVideoOutput.md#tags)
...
[`PornDoeVideoOutput`](PornDoeVideoOutput.md).[`pageUrl`](PornDoeVideoOutput.md#pageurl)
...
[`PornDoeVideoOutput`](PornDoeVideoOutput.md).[`poster`](PornDoeVideoOutput.md#poster)
...
[`PornDoeVideoOutput`](PornDoeVideoOutput.md).[`videos`](PornDoeVideoOutput.md#videos)
...
Defined in: [packages/providers/porndoe/PornDoeContracts.ts:7](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeContracts.ts#L7)

#### Inherited from

[`PornDoeVideoOutput`](PornDoeVideoOutput.md).[`preview`](PornDoeVideoOutput.md#preview)
...
Defined in: [packages/providers/porndoe/PornDoeContracts.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeContracts.ts#L8)

#### Inherited from

[`PornDoeVideoOutput`](PornDoeVideoOutput.md).[`id`](PornDoeVideoOutput.md#id)
...
Defined in: [packages/providers/porndoe/PornDoeContracts.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeContracts.ts#L9)

#### Inherited from

[`PornDoeVideoOutput`](PornDoeVideoOutput.md).[`uploader`](PornDoeVideoOutput.md#uploader)

***

### banners?

> `optional` **banners?**: `object`

Defined in: [packages/providers/porndoe/PornDoeContracts.ts:10](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/porndoe/PornDoeContracts.ts#L10)
...
[`PornDoeVideoOutput`](PornDoeVideoOutput.md).[`banners`](PornDoeVideoOutput.md#banners)
