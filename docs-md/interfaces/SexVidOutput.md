...
[downflux](../README.md) / SexVidOutput

# Interface: SexVidOutput

Defined in: [packages/providers/sexvid/SexVidContracts.ts:4](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/sexvid/SexVidContracts.ts#L4)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`SexVidVideoOutput`](SexVidVideoOutput.md)
...
[`SexVidVideoOutput`](SexVidVideoOutput.md).[`tags`](SexVidVideoOutput.md#tags)
...
[`SexVidVideoOutput`](SexVidVideoOutput.md).[`pageUrl`](SexVidVideoOutput.md#pageurl)
...
[`SexVidVideoOutput`](SexVidVideoOutput.md).[`poster`](SexVidVideoOutput.md#poster)
...
[`SexVidVideoOutput`](SexVidVideoOutput.md).[`videos`](SexVidVideoOutput.md#videos)
...
[`SexVidVideoOutput`](SexVidVideoOutput.md).[`videoId`](SexVidVideoOutput.md#videoid)
...
[`SexVidVideoOutput`](SexVidVideoOutput.md).[`previews`](SexVidVideoOutput.md#previews)
...
[`SexVidVideoOutput`](SexVidVideoOutput.md).[`timelineScreenCount`](SexVidVideoOutput.md#timelinescreencount)
...
[`SexVidVideoOutput`](SexVidVideoOutput.md).[`timelineScreens`](SexVidVideoOutput.md#timelinescreens)
...
[`SexVidVideoOutput`](SexVidVideoOutput.md).[`starred`](SexVidVideoOutput.md#starred)
...
[`SexVidVideoOutput`](SexVidVideoOutput.md).[`uploader`](SexVidVideoOutput.md#uploader)
