...
[downflux](../README.md) / XHamsterOutput

# Interface: XHamsterOutput

Defined in: [packages/providers/xhamster/XHamsterContracts.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xhamster/XHamsterContracts.ts#L5)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`XHamsterVideoOutput`](XHamsterVideoOutput.md)
...
[`XHamsterVideoOutput`](XHamsterVideoOutput.md).[`tags`](XHamsterVideoOutput.md#tags)
...
[`XHamsterVideoOutput`](XHamsterVideoOutput.md).[`pageUrl`](XHamsterVideoOutput.md#pageurl)
...
Defined in: [packages/providers/xhamster/XHamsterContracts.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xhamster/XHamsterContracts.ts#L8)

#### Inherited from

[`XHamsterVideoOutput`](XHamsterVideoOutput.md).[`thumbnailUrl`](XHamsterVideoOutput.md#thumbnailurl)
...
Defined in: [packages/providers/xhamster/XHamsterContracts.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xhamster/XHamsterContracts.ts#L9)

#### Inherited from

[`XHamsterVideoOutput`](XHamsterVideoOutput.md).[`masterPlaylistUrl`](XHamsterVideoOutput.md#masterplaylisturl)
...
Defined in: [packages/providers/xhamster/XHamsterContracts.ts:10](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xhamster/XHamsterContracts.ts#L10)

#### Inherited from

[`XHamsterVideoOutput`](XHamsterVideoOutput.md).[`defaultVideoUrl`](XHamsterVideoOutput.md#defaultvideourl)
...
Defined in: [packages/providers/xhamster/XHamsterContracts.ts:11](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xhamster/XHamsterContracts.ts#L11)

#### Inherited from

[`XHamsterVideoOutput`](XHamsterVideoOutput.md).[`username`](XHamsterVideoOutput.md#username)
