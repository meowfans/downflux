...
[downflux](../README.md) / XDeguOutput

# Interface: XDeguOutput

Defined in: [packages/providers/xdegu/XDeguContracts.ts:4](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xdegu/XDeguContracts.ts#L4)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`XDeguVideoOutput`](XDeguVideoOutput.md)
...
[`XDeguVideoOutput`](XDeguVideoOutput.md).[`tags`](XDeguVideoOutput.md#tags)
...
[`XDeguVideoOutput`](XDeguVideoOutput.md).[`pageUrl`](XDeguVideoOutput.md#pageurl)
...
[`XDeguVideoOutput`](XDeguVideoOutput.md).[`poster`](XDeguVideoOutput.md#poster)
...
[`XDeguVideoOutput`](XDeguVideoOutput.md).[`videos`](XDeguVideoOutput.md#videos)
...
[`XDeguVideoOutput`](XDeguVideoOutput.md).[`videoId`](XDeguVideoOutput.md#videoid)
...
[`XDeguVideoOutput`](XDeguVideoOutput.md).[`previews`](XDeguVideoOutput.md#previews)
...
[`XDeguVideoOutput`](XDeguVideoOutput.md).[`timelineScreenCount`](XDeguVideoOutput.md#timelinescreencount)
...
[`XDeguVideoOutput`](XDeguVideoOutput.md).[`timelineScreens`](XDeguVideoOutput.md#timelinescreens)
...
[`XDeguVideoOutput`](XDeguVideoOutput.md).[`starred`](XDeguVideoOutput.md#starred)
...
[`XDeguVideoOutput`](XDeguVideoOutput.md).[`uploader`](XDeguVideoOutput.md#uploader)
