...
[downflux](../README.md) / AnalRzOutput

# Interface: AnalRzOutput

Defined in: [packages/providers/analrz/AnalRzContracts.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/analrz/AnalRzContracts.ts#L5)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`AnalRzVideoOutput`](AnalRzVideoOutput.md)
...
[`AnalRzVideoOutput`](AnalRzVideoOutput.md).[`tags`](AnalRzVideoOutput.md#tags)
...
[`AnalRzVideoOutput`](AnalRzVideoOutput.md).[`pageUrl`](AnalRzVideoOutput.md#pageurl)
...
[`AnalRzVideoOutput`](AnalRzVideoOutput.md).[`poster`](AnalRzVideoOutput.md#poster)
...
[`AnalRzVideoOutput`](AnalRzVideoOutput.md).[`videos`](AnalRzVideoOutput.md#videos)
...
Defined in: [packages/providers/analrz/AnalRzContracts.ts:8](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/analrz/AnalRzContracts.ts#L8)

#### Inherited from

[`AnalRzVideoOutput`](AnalRzVideoOutput.md).[`videoId`](AnalRzVideoOutput.md#videoid)
...
Defined in: [packages/providers/analrz/AnalRzContracts.ts:9](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/analrz/AnalRzContracts.ts#L9)

#### Inherited from

[`AnalRzVideoOutput`](AnalRzVideoOutput.md).[`uploader`](AnalRzVideoOutput.md#uploader)
...
Defined in: [packages/providers/analrz/AnalRzContracts.ts:10](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/analrz/AnalRzContracts.ts#L10)

#### Inherited from

[`AnalRzVideoOutput`](AnalRzVideoOutput.md).[`actors`](AnalRzVideoOutput.md#actors)
...
Defined in: [packages/providers/analrz/AnalRzContracts.ts:11](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/analrz/AnalRzContracts.ts#L11)

#### Inherited from

[`AnalRzVideoOutput`](AnalRzVideoOutput.md).[`height`](AnalRzVideoOutput.md#height)
...
Defined in: [packages/providers/analrz/AnalRzContracts.ts:12](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/analrz/AnalRzContracts.ts#L12)

#### Inherited from

[`AnalRzVideoOutput`](AnalRzVideoOutput.md).[`width`](AnalRzVideoOutput.md#width)
