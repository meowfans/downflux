...
[downflux](../README.md) / InterracialOutput

# Interface: InterracialOutput

Defined in: [packages/providers/interracial/InterracialContracts.ts:4](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/interracial/InterracialContracts.ts#L4)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`InterracialVideoOutput`](InterracialVideoOutput.md)
...
[`InterracialVideoOutput`](InterracialVideoOutput.md).[`tags`](InterracialVideoOutput.md#tags)
...
[`InterracialVideoOutput`](InterracialVideoOutput.md).[`pageUrl`](InterracialVideoOutput.md#pageurl)
...
[`InterracialVideoOutput`](InterracialVideoOutput.md).[`poster`](InterracialVideoOutput.md#poster)
...
[`InterracialVideoOutput`](InterracialVideoOutput.md).[`videos`](InterracialVideoOutput.md#videos)
...
[`InterracialVideoOutput`](InterracialVideoOutput.md).[`videoId`](InterracialVideoOutput.md#videoid)
...
[`InterracialVideoOutput`](InterracialVideoOutput.md).[`previews`](InterracialVideoOutput.md#previews)
...
[`InterracialVideoOutput`](InterracialVideoOutput.md).[`timelineScreenCount`](InterracialVideoOutput.md#timelinescreencount)
...
[`InterracialVideoOutput`](InterracialVideoOutput.md).[`timelineScreens`](InterracialVideoOutput.md#timelinescreens)
...
[`InterracialVideoOutput`](InterracialVideoOutput.md).[`starred`](InterracialVideoOutput.md#starred)
...
[`InterracialVideoOutput`](InterracialVideoOutput.md).[`uploader`](InterracialVideoOutput.md#uploader)
