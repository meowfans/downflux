...
[downflux](../README.md) / EpicGfsOutput

# Interface: EpicGfsOutput

Defined in: [packages/providers/epicgfs/EpicGfsContracts.ts:4](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/epicgfs/EpicGfsContracts.ts#L4)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md)
...
[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md).[`tags`](EpicGfsVideoOutput.md#tags)
...
[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md).[`pageUrl`](EpicGfsVideoOutput.md#pageurl)
...
[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md).[`poster`](EpicGfsVideoOutput.md#poster)
...
[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md).[`videos`](EpicGfsVideoOutput.md#videos)
...
[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md).[`videoId`](EpicGfsVideoOutput.md#videoid)
...
[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md).[`previews`](EpicGfsVideoOutput.md#previews)
...
[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md).[`timelineScreenCount`](EpicGfsVideoOutput.md#timelinescreencount)
...
[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md).[`timelineScreens`](EpicGfsVideoOutput.md#timelinescreens)
...
[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md).[`starred`](EpicGfsVideoOutput.md#starred)
...
[`EpicGfsVideoOutput`](EpicGfsVideoOutput.md).[`uploader`](EpicGfsVideoOutput.md#uploader)
