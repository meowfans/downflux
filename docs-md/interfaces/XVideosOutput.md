...
[downflux](../README.md) / XVideosOutput

# Interface: XVideosOutput

Defined in: [packages/providers/xvideos/XVideosContracts.ts:5](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xvideos/XVideosContracts.ts#L5)
...
- [`DefaultExecutionResult`](DefaultExecutionResult.md).[`XVideosVideoOutput`](XVideosVideoOutput.md)
...
[`XVideosVideoOutput`](XVideosVideoOutput.md).[`tags`](XVideosVideoOutput.md#tags)
...
[`XVideosVideoOutput`](XVideosVideoOutput.md).[`pageUrl`](XVideosVideoOutput.md#pageurl)
...
Defined in: [packages/providers/xvideos/XVideosContracts.ts:14](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xvideos/XVideosContracts.ts#L14)

#### Inherited from

[`XVideosVideoOutput`](XVideosVideoOutput.md).[`duration`](XVideosVideoOutput.md#duration)
...
Defined in: [packages/providers/xvideos/XVideosContracts.ts:15](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xvideos/XVideosContracts.ts#L15)

#### Inherited from

[`XVideosVideoOutput`](XVideosVideoOutput.md).[`videoUrl`](XVideosVideoOutput.md#videourl)
...
Defined in: [packages/providers/xvideos/XVideosContracts.ts:16](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xvideos/XVideosContracts.ts#L16)

#### Inherited from

[`XVideosVideoOutput`](XVideosVideoOutput.md).[`poster`](XVideosVideoOutput.md#poster)
...
Defined in: [packages/providers/xvideos/XVideosContracts.ts:17](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xvideos/XVideosContracts.ts#L17)

#### Inherited from

[`XVideosVideoOutput`](XVideosVideoOutput.md).[`uploader`](XVideosVideoOutput.md#uploader)
...
Defined in: [packages/providers/xvideos/XVideosContracts.ts:18](https://github.com/cloudgrids/downflux/blob/1f8790287a3ea22feb0e5a1f559d29d445cd9a44/packages/providers/xvideos/XVideosContracts.ts#L18)

#### Inherited from

[`XVideosVideoOutput`](XVideosVideoOutput.md).[`models`](XVideosVideoOutput.md#models)
